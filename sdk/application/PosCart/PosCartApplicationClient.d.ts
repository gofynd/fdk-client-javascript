...
declare class PosCart {
     ...
     */
    addAddress({ body }?: PosCartApplicationValidator.AddAddressParam): Promise<PosCartApplicationModel.SaveAddressResponse>;
    /**
     ...
     */
    addItems({ body, i, b, p, areaCode, buyNow, id }?: PosCartApplicationValidator.AddItemsParam): Promise<PosCartApplicationModel.AddCartDetailResponse>;
    /**
     ...
     */
    applyCoupon({ body, i, b, p, id, buyNow }?: PosCartApplicationValidator.ApplyCouponParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    applyRewardPoints({ body, id, i, b, buyNow }?: PosCartApplicationValidator.ApplyRewardPointsParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    checkoutCart({ body, id }?: PosCartApplicationValidator.CheckoutCartParam): Promise<PosCartApplicationModel.CartCheckoutResponse>;
    /**
     ...
     */
    getAddressById({ id, cartId, buyNow, mobileNo, checkoutMode, tags, isDefault, }?: PosCartApplicationValidator.GetAddressByIdParam): Promise<PosCartApplicationModel.Address>;
    /**
     ...
     */
    getAddresses({ cartId, buyNow, mobileNo, checkoutMode, tags, isDefault, }?: PosCartApplicationValidator.GetAddressesParam): Promise<PosCartApplicationModel.GetAddressesResponse>;
    /**
     ...
     */
    getAvailableDeliveryModes({ areaCode, id }?: PosCartApplicationValidator.GetAvailableDeliveryModesParam): Promise<PosCartApplicationModel.CartDeliveryModesResponse>;
    /**
     ...
     */
    getBulkDiscountOffers({ itemId, articleId, uid, slug }?: PosCartApplicationValidator.GetBulkDiscountOffersParam): Promise<PosCartApplicationModel.BulkPriceResponse>;
    /**
     ...
     */
    getCart({ id, i, b, p, assignCardId, areaCode, buyNow }?: PosCartApplicationValidator.GetCartParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    getCartLastModified({ id }?: PosCartApplicationValidator.GetCartLastModifiedParam): Promise<any>;
    /**
     ...
     */
    getCartShareLink({ body }?: PosCartApplicationValidator.GetCartShareLinkParam): Promise<PosCartApplicationModel.GetShareCartLinkResponse>;
    /**
     ...
     */
    getCartSharedItems({ token }?: PosCartApplicationValidator.GetCartSharedItemsParam): Promise<PosCartApplicationModel.SharedCartResponse>;
    /**
     ...
     */
    getCoupons({ id, buyNow }?: PosCartApplicationValidator.GetCouponsParam): Promise<PosCartApplicationModel.GetCouponResponse>;
    /**
     ...
     */
    getItemCount({ id, buyNow }?: PosCartApplicationValidator.GetItemCountParam): Promise<PosCartApplicationModel.CartItemCountResponse>;
    /**
     ...
     */
    getShipments({ pickAtStoreUid, orderingStoreId, p, id, addressId, areaCode, orderType, }?: PosCartApplicationValidator.GetShipmentsParam): Promise<PosCartApplicationModel.CartShipmentsResponse>;
    /**
     ...
     */
    getStoreAddressByUid({ storeUid }?: PosCartApplicationValidator.GetStoreAddressByUidParam): Promise<PosCartApplicationModel.StoreDetailsResponse>;
    /**
     ...
     */
    removeAddress({ id }?: PosCartApplicationValidator.RemoveAddressParam): Promise<PosCartApplicationModel.DeleteAddressResponse>;
    /**
     ...
     */
    removeCoupon({ id, buyNow }?: PosCartApplicationValidator.RemoveCouponParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    selectAddress({ body, cartId, buyNow, i, b }?: PosCartApplicationValidator.SelectAddressParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    selectPaymentMode({ body, id, buyNow }?: PosCartApplicationValidator.SelectPaymentModeParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    updateAddress({ id, body }?: PosCartApplicationValidator.UpdateAddressParam): Promise<PosCartApplicationModel.UpdateAddressResponse>;
    /**
     ...
     */
    updateCart({ body, id, i, b, p, areaCode, buyNow }?: PosCartApplicationValidator.UpdateCartParam): Promise<PosCartApplicationModel.UpdateCartDetailResponse>;
    /**
     ...
     */
    updateCartMeta({ body, id, buyNow }?: PosCartApplicationValidator.UpdateCartMetaParam): Promise<PosCartApplicationModel.CartMetaResponse>;
    /**
     ...
     */
    updateCartWithSharedItems({ token, action }?: PosCartApplicationValidator.UpdateCartWithSharedItemsParam): Promise<PosCartApplicationModel.SharedCartResponse>;
    /**
     ...
     */
    updateShipments({ body, i, p, id, addressId, areaCode, orderType, }?: PosCartApplicationValidator.UpdateShipmentsParam): Promise<PosCartApplicationModel.CartShipmentsResponse>;
    /**
     ...
     */
    validateCouponForPayment({ id, buyNow, addressId, paymentMode, paymentIdentifier, aggregatorName, merchantCode, iin, network, type, cardId, }?: PosCartApplicationValidator.ValidateCouponForPaymentParam): Promise<PosCartApplicationModel.PaymentCouponValidate>;
}

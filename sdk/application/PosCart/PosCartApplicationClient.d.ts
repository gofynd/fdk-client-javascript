...
declare class PosCart {
     ...
     */
    addItems({ body, i, b, areaCode, buyNow, id }?: PosCartApplicationValidator.AddItemsParam): Promise<PosCartApplicationModel.AddCartDetailResponse>;
    /**
     ...
     */
    getCart({ id, i, b, assignCardId, areaCode, buyNow }?: PosCartApplicationValidator.GetCartParam): Promise<PosCartApplicationModel.CartDetailResponse>;
    /**
     ...
     */
    updateCart({ body, id, i, b, areaCode, buyNow }?: PosCartApplicationValidator.UpdateCartParam): Promise<PosCartApplicationModel.UpdateCartDetailResponse>;
    /**

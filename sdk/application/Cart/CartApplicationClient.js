...
class Cart {
   ...
   */
  async addItems({ body, i, b, areaCode } = {}) {
   ...
   */
  async applyCoupon({ body, i, b, p, id } = {}) {
   ...
   */
  async applyRewardPoints({ body, id, i, b } = {}) {
   ...
   */
  async getAddresses({ cartId, mobileNo, checkoutMode, tags, isDefault } = {}) {
   ...
   */
  async getCart({ id, i, b, assignCardId, areaCode } = {}) {
   ...
   */
  async getShipments({ p, id, addressId, areaCode, orderType } = {}) {
   ...
   */
  async selectAddress({ body, cartId, i, b } = {}) {
   ...
   */
  async selectPaymentMode({ body, id } = {}) {
   ...
   */
  async updateCart({ body, id, i, b, areaCode } = {}) {

...
declare class FileStorage {
     ...
     */
    browse({ namespace, page, limit }?: FileStoragePlatformValidator.BrowseParam, { headers }?: import("../PlatformAPIClient").Options): Promise<FileStoragePlatformModel.BrowseResponse>;
    /**

...
class Serviceability {
  ...
  async createCourierPartnerScheme(
    ...
    const response = await PlatformAPIClient.execute(
      this.config,
      "post",
      `/service/platform/logistics/v1.0/company/${this.config.companyId}/courier-partner/scheme`,
      query_params,
      body,
      { ...xHeaders, ...requestHeaders },
      { responseHeaders }
    ...
    const {
      error: res_error,
    } = ServiceabilityPlatformModel.CourierPartnerSchemeModel().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getSampleFileServiceabilityStatus(
    ...
    const {
      error: res_error,
    } = ServiceabilityPlatformModel.BulkRegionServiceabilityTatResponse().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async sampleFileServiceability(
    ...
    const {
      error: res_error,
    } = ServiceabilityPlatformModel.BulkRegionServiceabilityTatResponseItemData().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async updateCourierPartnerScheme(
    ...
    const response = await PlatformAPIClient.execute(
      this.config,
      "put",
      `/service/platform/logistics/v1.0/company/${this.config.companyId}/courier-partner/scheme/${schemeId}`,
      query_params,
      body,
      { ...xHeaders, ...requestHeaders },
      { responseHeaders }
    ...
    const {
      error: res_error,
    } = ServiceabilityPlatformModel.CourierPartnerSchemeUpdateRequest().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );

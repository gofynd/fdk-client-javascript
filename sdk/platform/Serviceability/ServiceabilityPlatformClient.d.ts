...
declare class Serviceability {
     ...
     */
    getLocalities({ localityType, country, state, city, pageNo, pageSize, q, requestHeaders, }?: ServiceabilityPlatformValidator.GetLocalitiesParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.GetLocalities>;
    /**

...
declare namespace ServiceabilityPlatformValidator {
    export { BulkServiceabilityParam, BulkTatParam, CreateCourierPartnerAccountParam, CreateCourierPartnerSchemeParam, CreatePackageMaterialParam, CreatePackageMaterialRuleParam, GetBulkServiceabilityParam, GetBulkTatParam, GetCompanyConfigurationParam, GetCompanySelfShipParam, GetCountriesParam, GetCountryParam, GetCourierPartnerAccountParam, GetCourierPartnerAccountsParam, GetInstalledCourierPartnerExtensionsParam, GetListPackageMaterialRuleDetailsParam, GetLocalitiesParam, GetLocalitiesByPrefixParam, GetLocalityParam, GetOptimalLocationsParam, GetPackageMaterialListParam, GetPackageMaterialRuleParam, GetPackageMaterialRuleDetailsParam, GetPackageMaterialsParam, GetSampleFileServiceabilityStatusParam, SampleFileServiceabilityParam, UpdateCompanyConfigurationParam, UpdateCompanySelfShipParam, UpdateCourierPartnerAccountParam, UpdateCourierPartnerSchemeParam, UpdatePackageMaterialRuleParam, UpdatePackageMaterialsParam, ValidateAddressParam };
}
...
type CreateCourierPartnerSchemeParam = {
    body: ServiceabilityPlatformModel.CourierPartnerSchemeModel;
};
...
type SampleFileServiceabilityParam = {
    body: ServiceabilityPlatformModel.BulkRegionServiceabilityTatRequest;
};
...
type UpdateCourierPartnerSchemeParam = {
     ...
     */
    schemeId: string;
    body: ServiceabilityPlatformModel.CourierPartnerSchemeUpdateRequest;
};

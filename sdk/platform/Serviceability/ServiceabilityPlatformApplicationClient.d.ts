...
declare class Serviceability {
     ...
     */
    getBulkGeoareaValidation({ batchId, requestHeaders }?: ServiceabilityPlatformApplicationValidator.GetBulkGeoareaValidationParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.ZoneBulkValidationStatusResponse>;
    /**
     ...
     */
    getGeoareaOverrideStatus({ batchId, requestHeaders }?: ServiceabilityPlatformApplicationValidator.GetGeoareaOverrideStatusParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.ZoneOverrideStatusResponseSchema>;
    /**
     ...
     */
    importBulkGeoarea({ batchId, requestHeaders }?: ServiceabilityPlatformApplicationValidator.ImportBulkGeoareaParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.ZoneBulkValidationStatusResponse>;
    /**
     ...
     */
    importBulkGeoareaStatus({ batchId, requestHeaders }?: ServiceabilityPlatformApplicationValidator.ImportBulkGeoareaStatusParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.ZoneBulkImportResponse>;
    /**
     ...
     */
    overrideBulkGeoarea({ batchId, body, requestHeaders }?: ServiceabilityPlatformApplicationValidator.OverrideBulkGeoareaParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.BulkZoneOverrideResponseSchema>;
    /**
     ...
     */
    validateBulkGeoarea({ body, requestHeaders }?: ServiceabilityPlatformApplicationValidator.ValidateBulkGeoareaParam, { responseHeaders }?: object): Promise<ServiceabilityPlatformModel.ZoneBulkValidationResponse>;
    /**

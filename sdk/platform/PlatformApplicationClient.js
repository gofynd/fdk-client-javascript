...
class Orders {
  ...
  getLaneConfigCrossSellingData({
    ...
    const { error } = OrdersValidator.getLaneConfigCrossSellingData().validate(
      {
        superLane,
        groupEntity,
        fromDate,
    ...
    return PlatformAPIClient.execute(
      this.config,
      "get",
      `/service/platform/orders/v1.0/company/${this.config.companyId}/application/${this.applicationId}/lane-config/`,
      query_params,
      undefined
    );
  }
  ...
  getAppOrderShipmentDetails({ orderId } = {}) {
    const { error } = OrdersValidator.getAppOrderShipmentDetails().validate(
      {
        orderId,
      },
      { abortEarly: false, allowUnknown: true }

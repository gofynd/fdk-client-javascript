...
class Webhook {
  ...
  async cancelJobByName({ filename } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.CancelResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async getDeliveryReports({ body } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.EventProcessReports().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async getEventCounts({ body } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.FailedEventsCountSuccessResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async getHistoricalReports({ body } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.HistoryResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async getManualRetryStatus({} = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.RetryStatusResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async getReportFilters({ body } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.ReportFilterResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async manualRetryCancel({} = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.EventSuccessResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async manualRetryOfFailedEvent({ body } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.EventProcessedSuccessResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });
  ...
  async pingWebhook({ body } = {}) {
    ...
    const {
      error: res_error,
    } = WebhookModel.PingWebhookResponse().validate(response, {
      abortEarly: false,
      allowUnknown: false,
    });

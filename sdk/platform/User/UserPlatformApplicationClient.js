...
class User {
   ...
   */
  async bulkUpdatePerUserAttributes(
    { body, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = UserPlatformApplicationValidator.bulkUpdatePerUserAttributes().validate(
      {
        body,
      },
      { abortEarly: false, allowUnknown: true }
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for platform > User > bulkUpdatePerUserAttributes \n ${warrning}`,
      });
    }
    ...
    const response = await PlatformAPIClient.execute(
      this.config,
      "put",
      `/service/platform/user/v1.0/company/${this.config.companyId}/application/${this.applicationId}/user_attribute/bulk_update/per_user`,
      query_params,
      body,
      requestHeaders,
      { responseHeaders }
    ...
    const {
      error: res_error,
    } = UserPlatformModel.BulkOperation().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for platform > User > bulkUpdatePerUserAttributes \n ${res_error}`,
        });
      }
    }
   ...
   */
  async bulkUpdateUserAttributes(
    { body, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = UserPlatformApplicationValidator.bulkUpdateUserAttributes().validate(
      {
        body,
      },
      { abortEarly: false, allowUnknown: true }
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for platform > User > bulkUpdateUserAttributes \n ${warrning}`,
      });
    }
    ...
    const response = await PlatformAPIClient.execute(
      this.config,
      "put",
      `/service/platform/user/v1.0/company/${this.config.companyId}/application/${this.applicationId}/user_attribute/bulk_update`,
      query_params,
      body,
      requestHeaders,
      { responseHeaders }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for platform > User > bulkUpdateUserAttributes \n ${res_error}`,
        });
      }
    }
   ...
   */
  async getUserGroupCategories(
    { requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = UserPlatformApplicationValidator.getUserGroupCategories().validate(
      {},
      { abortEarly: false, allowUnknown: true }
    );
    if (error) {
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for platform > User > getUserGroupCategories \n ${warrning}`,
      });
    }
    ...
    const response = await PlatformAPIClient.execute(
      this.config,
      "get",
      `/service/platform/user/v1.0/company/${this.config.companyId}/application/${this.applicationId}/user_group/categories`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
    ...
    const {
      error: res_error,
    } = UserPlatformModel.UserGroupCategoriesResponseSchema().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for platform > User > getUserGroupCategories \n ${res_error}`,
        });
      }
    }

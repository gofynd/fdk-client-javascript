...
declare class User {
     ...
     */
    searchUsers({ q }?: UserPlatformApplicationValidator.SearchUsersParam, { headers }?: import("../PlatformAPIClient").Options): Promise<UserPlatformModel.UserSearchResponseSchema>;
    /**

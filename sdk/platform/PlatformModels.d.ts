...
export type SystemEmailTemplates = {
    docs?: Array<SystemEmailTemplate>;
    total?: number;
    limit?: number;
    offset?: number;
    page?: number;

...
class FinancePlatformModel {
  ...
  static AsCnRefundRequest() {
    return Joi.object({
      data: FinancePlatformModel.AsCnRefundData(),
    });
  }

  /** @returns {AsCnRefundResponse} */
  static AsCnRefundResponse() {
    return Joi.object({
      data: FinancePlatformModel.AsCnRefundResponseData(),
      success: Joi.boolean(),
    });
  }

  /** @returns {AsCnRefundResponseData} */
  static AsCnRefundResponseData() {
    return Joi.object({
  ...
  static CreditNoteDetails() {
    return Joi.object({
      ...
      cn_details: Joi.array().items(FinancePlatformModel.CnDetails()),
      cn_reference_number: Joi.string().allow(""),

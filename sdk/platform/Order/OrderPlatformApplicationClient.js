...
class Order {
  ...
  async createRule(
    ...
    const {
      error: res_error,
    } = OrderPlatformModel.CreateRuleResponse().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async deleteRule(
    ...
    const {
      error: res_error,
    } = OrderPlatformModel.DeleteRuleResponse().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async updateRule(
    ...
    const {
      error: res_error,
    } = OrderPlatformModel.RuleUpdateResponse().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async updateRulePosition(
    ...
    const {
      error: res_error,
    } = OrderPlatformModel.UpdateRulePositionResponse().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });

...
class CartPlatformModel {
  ...
  static CouponObj() {
    return Joi.object({
      draft: Joi.number().allow(null),
      review: Joi.number().allow(null),
      rejected: Joi.number().allow(null),
  ...
  static CouponDetailResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
  ...
  static OperationErrorResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
      message: Joi.string().allow(""),
  ...
  static CartMetaConfigOperationErrorObject() {
    return Joi.object({
      success: Joi.boolean(),
      message: Joi.string().allow(""),
  ...
  static PromotionAction() {
    return Joi.object({
      action_date: Joi.string().allow("").required(),
  ...
  static PromotionsResponseObject() {
    return Joi.object({
      draft: Joi.number().allow(null),
      review: Joi.number().allow(null),
      rejected: Joi.number().allow(null),
  ...
  static PromotionAddResult() {
    return Joi.object({
      ...
      rejected: Joi.number(),
      approved: Joi.number(),
      offer_counts: Joi.number(),
      offer_prefix: Joi.string().allow(""),
      is_bank_offer: Joi.boolean(),
      custom_content: Joi.object().pattern(/\S/, Joi.any()),
      medias: Joi.array().items(CartPlatformModel.Media()),
      offer_type: Joi.string().allow(""),
      visibility: CartPlatformModel.Visibility(),
      is_archived: Joi.boolean(),
      stackable: Joi.boolean(),
      calculate_on: Joi.string().allow(""),
      apply_exclusive: Joi.string().allow("").allow(null),
  ...
  static ActivePromosResponseObject() {
    return Joi.object({
      status: Joi.string().allow(""),
  ...
  static CartMetaConfigDetailObject() {
    return Joi.object({
      success: Joi.boolean(),
  ...
  static CartMetaConfigListResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
  ...
  static CartMetaConfigListObject() {
    return Joi.object({
      ...
      max_cart_items: Joi.number(),
      gift_display_text: Joi.string().allow(""),
      delivery_charges: CartPlatformModel.DeliveryChargesConfig(),
      revenue_engine_coupon: Joi.boolean(),
      gift_pricing: Joi.number(),
      enabled: Joi.boolean(),
      is_active: Joi.boolean(),
      ...
      is_universal: Joi.boolean(),
      empty_cart: Joi.boolean(),
      international_delivery_charges: CartPlatformModel.DeliveryChargesConfig(),
    });
  }

  /** @returns {CartMetaConfigAddResponseObject} */
  static CartMetaConfigAddResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
  ...
  static PriceAdjustmentUpdate() {
    return Joi.object({
      ...
      distribution_logic: Joi.object().pattern(/\S/, Joi.any()),
    });
  }
  ...
  static AddPriceAdjustmentResponseObject() {
    return Joi.object({
  ...
  static UpdatePriceAdjustmentResponseObject() {
    return Joi.object({
      data: CartPlatformModel.PriceAdjustment(),
      success: Joi.boolean(),
    });
  ...
  static PriceAdjustmentResponsObject() {
    return Joi.object({
  ...
  static GetPriceAdjustmentResponseObject() {
    return Joi.object({
      data: Joi.array().items(CartPlatformModel.PriceAdjustment()),
    });
  }
  ...
  static DistributionLogic() {
    return Joi.object({
      ...
      distribution: Joi.object().pattern(/\S/, Joi.any()),
    });
  }
  ...
  static OpenapiCartDetailsRequestObject() {
    return Joi.object({
  ...
  static PriceAdjustmentApplied() {
    return Joi.object({
      applied_articles_ids: Joi.array().items(
  ...
  static OpenapiCartDetailsResponseObject() {
    return Joi.object({
      cart_id: Joi.number(),
      uid: Joi.string().allow(""),
      ...
      error_code: Joi.string().allow("").allow(null),
    });
  }

  /** @returns {OpenApiErrorResponseObject} */
  static OpenApiErrorResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
      message: Joi.string().allow(""),
      errors: Joi.object().pattern(/\S/, Joi.any()),
  ...
  static OpenApiCartServiceabilityRequestObject() {
    return Joi.object({
      cart_items: Joi.array().items(CartPlatformModel.CartItem()).required(),
  ...
  static OpenApiCartServiceabilityResponseObject() {
    return Joi.object({
      cart_id: Joi.number(),
      uid: Joi.string().allow(""),
      coupon_text: Joi.string().allow(""),
  ...
  static OpenApiCheckoutResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
      message: Joi.string().allow(""),
  ...
  static AbandonedCartResponseObject() {
    return Joi.object({
  ...
  static CartDetailResponseObject() {
    return Joi.object({
      cart_id: Joi.number(),
      uid: Joi.string().allow(""),
      coupon_text: Joi.string().allow(""),
  ...
  static AddCartDetailResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
      cart: CartPlatformModel.CartDetailResponseObject(),
      partial: Joi.boolean(),
      message: Joi.string().allow(""),
      result: Joi.object().pattern(/\S/, Joi.any()),
      error_code: Joi.string().allow("").allow(null),
  ...
  static UpdateCartRequestObject() {
    return Joi.object({
  ...
  static UpdateCartDetailResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
      cart: CartPlatformModel.CartDetailResponseObject(),
      message: Joi.string().allow(""),
  ...
  static OverrideCheckoutResponseObject() {
    return Joi.object({
  ...
  static GetShareCartLinkRequestObject() {
    return Joi.object({
      id: Joi.string().allow(""),
      meta: Joi.object().pattern(/\S/, Joi.any()),
    });
  ...
  static GetShareCartLinkResponseObject() {
    return Joi.object({
  ...
  static SharedCartResponseObject() {
    return Joi.object({
  ...
  static MultiCartResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
  ...
  static UserCartMappingResponseObject() {
    return Joi.object({
      is_valid: Joi.boolean(),
      message: Joi.string().allow(""),
      success: Joi.boolean(),
  ...
  static PlatformAddCartRequestObject() {
    return Joi.object({
      user_id: Joi.string().allow(""),
      new_cart: Joi.boolean(),
      items: Joi.array().items(CartPlatformModel.AddProductCart()),
  ...
  static PlatformUpdateCartRequestObject() {
    return Joi.object({
      user_id: Joi.string().allow(""),
      items: Joi.array().items(CartPlatformModel.UpdateProductCart()),
      operation: Joi.string().allow("").required(),
  ...
  static DeleteCartRequestObject() {
    return Joi.object({
  ...
  static DeleteCartDetailResponseObject() {
    return Joi.object({
      success: Joi.boolean(),
      message: Joi.string().allow(""),
    });
  ...
  static CartItemCountResponseObject() {
    return Joi.object({
  ...
  static GetCouponResponseObject() {
    return Joi.object({
  ...
  static ApplyCouponRequestObject() {
    return Joi.object({
      coupon_code: Joi.string().allow("").required(),
    });
  }
  ...
  static PlatformGetAddressesResponseObject() {
    return Joi.object({
  ...
  static SaveAddressResponseObject() {
    return Joi.object({
      id: Joi.string().allow(""),
      success: Joi.boolean(),
      is_default_address: Joi.boolean(),
  ...
  static UpdateAddressResponseObject() {
    return Joi.object({
      id: Joi.string().allow(""),
      is_default_address: Joi.boolean(),
      success: Joi.boolean(),
  ...
  static DeleteAddressResponseObject() {
    return Joi.object({
      id: Joi.string().allow(""),
  ...
  static PlatformSelectCartAddressRequestObject() {
    return Joi.object({
      cart_id: Joi.string().allow(""),
  ...
  static PlatformShipmentResponseObject() {
    return Joi.object({
      ...
      debug: Joi.object().pattern(/\S/, Joi.any()),
    });
  }
  ...
  static ShipmentMeta() {
    return Joi.object({
      ...
      debug: Joi.object().pattern(/\S/, Joi.any()).allow(null, ""),
    });
  }
  ...
  static PlatformCartShipmentsResponseObject() {
    return Joi.object({
      cart_id: Joi.number(),
      uid: Joi.string().allow(""),
      coupon_text: Joi.string().allow(""),
      ...
      shipments: Joi.array().items(
        CartPlatformModel.PlatformShipmentResponseObject()
      ),
      error: Joi.boolean(),
      is_pan_received: Joi.boolean(),
      custom_cart_meta: Joi.object().pattern(/\S/, Joi.any()),
  ...
  static UpdateCartShipmentRequestObject() {
    return Joi.object({
      shipments: Joi.array()
  ...
  static PlatformCartMetaRequestObject() {
    return Joi.object({
  ...
  static CartMetaMissingResponseObject() {
    return Joi.object({
  ...
  static PlatformCartCheckoutDetailRequestObject() {
    return Joi.object({
      ...
      payment_mode: Joi.string().allow("").required(),
      checkout_mode: Joi.string().allow(""),
      customer_details: Joi.object().pattern(/\S/, Joi.any()).allow(null, ""),
      meta: Joi.object().pattern(/\S/, Joi.any()),
  ...
  static CartCheckoutResponseObject() {
    return Joi.object({
      app_intercept_url: Joi.string().allow(""),
      error_message: Joi.string().allow(""),
      data: Joi.object().pattern(/\S/, Joi.any()),
  ...
  static CartDeliveryModesResponseObject() {
    return Joi.object({
  ...
  static StoreDetailsResponseObject() {
    return Joi.object({
  ...
  static UpdateCartPaymentRequestObject() {
    return Joi.object({
      address_id: Joi.string().allow(""),
      payment_mode: Joi.string().allow(""),
  ...
  static PlatformCartCheckoutDetailV2RequestObject() {
    return Joi.object({
      address_id: Joi.string().allow(""),
      payment_identifier: Joi.string().allow("").allow(null),
      payment_params: Joi.object().pattern(/\S/, Joi.any()).allow(null, ""),
  ...
  static PromotionOffersResponseObject() {
    return Joi.object({

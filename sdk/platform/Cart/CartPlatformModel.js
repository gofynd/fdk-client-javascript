...
class CartPlatformModel {
  ...
  static CartDynamicInjection() {
    return Joi.object({
      ...
      collection: CartPlatformModel.Collecttion().required(),
  ...
  static CartDynamicInjectionResponse() {
    return Joi.object({
      data: CartPlatformModel.CartDynamicInjection(),
    });
  }
  ...
  static CartProduct() {
    return Joi.object({
      ...
      name: Joi.string().allow(""),
      net_quantity: CartPlatformModel.NetQuantity(),
  ...
  static PromotionsResponse() {
    return Joi.object({
      items: CartPlatformModel.PromotionListItem(),
      page: CartPlatformModel.Page(),
    });
  }

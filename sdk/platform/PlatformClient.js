...
class Catalog {
  ...
  getProductAttributes({
    ...
    query_params["department"] = department;
    query_params["category"] = category;
    query_params["filtered"] = filtered;
    query_params["page_no"] = pageNo;
    query_params["page_size"] = pageSize;
...
class Orders {
  ...
  getLaneConfig({ superLane, fromDate, toDate } = {}) {
    ...
    return PlatformAPIClient.execute(
      this.config,
      "get",
      `/service/platform/orders/v1.0/company/${this.config.companyId}/store/lane-config/`,
      query_params,
      undefined
    );
  }
  ...
  getShipmentList({ lane, searchType, searchId, fromDate, toDate } = {}) {
    ...
    return PlatformAPIClient.execute(
      this.config,
      "get",
      `/service/platform/orders/v1.0/company/${this.config.companyId}/shipments-internal`,
      query_params,
      undefined
    );
  }

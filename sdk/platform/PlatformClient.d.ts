...
declare class Catalog {
     ...
     */
    getProducts({ brandIds, categoryIds, q, pageNo, pageSize }?: {
        brandIds?: number;
        categoryIds?: number;
        q?: string;
        pageNo?: number;

 ...
 */
/**
 * @typedef EntityRegionView_Request_schema
 * @property {string[]} sub_type
 ...
 */
/**
 * @typedef EntityRegionView_Response_schema
 ...
 */
/**
 * @typedef CompanyStoreView_Response_schema
...
declare class Serviceability {
     ...
     * @description: This API returns response of insertation of zone in mongo database.<br>Correction- `zone_id` in the path must be removed.<br> path is `/service/platform/logistics-internal/v1.0/company/{company_id}/zone/`
     */
    upsertZoneControllerView({ zoneId, body }?: {
        zoneId: string;
        body: ZoneRequest;
    }): any;
    /**
...
type EntityRegionView_Request_schema = {
    sub_type: string[];
    parent_id?: string[];
};
...
type EntityRegionView_Response_schema = {
...
type CompanyStoreView_Response_schema = {

...
type CollectionActionPage = {
    query?: CollectionActionPageQuery;
    type?: string;
};
type CollectionActionPageQuery = {
    attribute?: string;
    op?: string;
    value?: string[];
};
...
type CollectionScheduleStartEnd = {
    end?: string;
    start?: string;
};

...
declare class Orders {
     ...
     * @description:
     */
    getLaneConfig({ superLane, fromDate, toDate }?: {
        superLane?: string;
        fromDate?: string;
        toDate?: string;
    }): globalThis.Promise<any>;
     ...
     * @description:
     */
    getShipmentList({ lane, searchType, searchId, fromDate, toDate }?: {
        lane?: string;
        searchType?: string;
        searchId?: string;
        fromDate?: string;

...
type OrderDetails = {
    items: Array<OrderPicklistListing>;
    page: PlatformOrderPage;
    filters: Filters;
    next_order_status: any;
    applied_filters: AppliedFilters;

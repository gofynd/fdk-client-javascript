...
declare class Catalog {
     ...
     */
    getProducts({ brandIds, categoryIds, departmentIds, q, pageNo, pageSize, }?: {
        brandIds?: number[];
        categoryIds?: number[];

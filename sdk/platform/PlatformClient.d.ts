 ...
 * @property {StageReason[]} [stage_reason]
 * @property {string} [stage]
 */
/**
 ...
 * @property {string} shipment_id
 * @property {UserDetails} [delivery_details]
 * @property {ShipmentPrices} [shipment_prices]
 * @property {UserDetails} [billing_details]

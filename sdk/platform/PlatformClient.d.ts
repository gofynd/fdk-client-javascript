...
type GetZonesForZoneFromPincode = {
    store_ids: number[];
    tags: string[];
    type: string;
    zone_id: string;
...
type GetZoneFromPincodeViewResponse = {
    serviceability_type: string;
    zones: GetZonesForZoneFromPincode[];
};

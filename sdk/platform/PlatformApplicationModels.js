...
class Validator {
  ...
  static PathMappingSchema() {
    return Joi.object({
      ...
      __source: this.PathSourceSchema(),
    });
  }
  ...
  static RepaymentDetailsSerialiserPayAll() {
    return Joi.object({
      shipment_details: Joi.array().items(this.RepaymentRequestDetails()),
  ...
  static PincodeMOPresponse() {
    return Joi.object({
      ...
      updated_pincodes: Joi.array().items(this.PincodeMopUpdateResponse()),
    });
  }
  ...
  static PincodeCodStatusListingResponse() {
    return Joi.object({
      ...
      data: Joi.array()
        .items(this.PincodeCodStatusListingResponse())
        .required(),

      success: Joi.boolean().required(),

      errors: Joi.array().items(this.Error()),

      page: this.PincodeCodStatusListingPage().required(),

      summary: this.PincodeCodStatusListingSummary().required(),
    });
  }
  ...
  static PincodeMopUpdateAuditHistoryResponseData() {
    return Joi.object({
      ...
      page: this.PincodeMopUpdateAuditHistoryPaging().required(),

      data: Joi.array()
        .items(this.PincodeMopUpdateAuditHistoryResponse())
        .required(),
    });
  }
}
...
class UserValidator {
  ...
  static createUserGroup() {
    return Joi.object({
      body: Validator.CreateUserGroupSchema().required(),
    }).required();
  }
  ...
  static updateUserGroup() {
    return Joi.object({
      ...
      body: Validator.UpdateUserGroupSchema().required(),
    }).required();
  }
...
class ContentValidator {
  ...
  static generateSEOTitle() {
    return Joi.object({
      type: Validator.GenerationEntityType().required(),
      body: Validator.GenerateSEOContent().required(),
    }).required();
  }
...
class PaymentValidator {
  ...
  static repaymentDetails() {
    return Joi.object({
      body: Validator.RepaymentDetailsSerialiserPayAll().required(),
    }).required();
  }

  static merchantOnBoarding() {
    return Joi.object({
      body: Validator.MerchantOnBoardingRequest().required(),
    }).required();
  }
}
...
class ServiceabilityValidator {
  ...
  static updatePincodeMopView() {
    return Joi.object({
      body: Validator.PincodeMopData().required(),
    }).required();
  }

  static updatePincodeBulkView() {
    return Joi.object({
      body: Validator.PincodeMopBulkData().required(),
    }).required();
  }

  static updatePincodeCoDListing() {
    return Joi.object({
      body: Validator.PincodeCodStatusListingRequest().required(),
    }).required();
  }

  static updatePincodeAuditHistory() {
    return Joi.object({
      body: Validator.PincodeMopUpdateAuditHistoryRequest().required(),
    }).required();
  }
}

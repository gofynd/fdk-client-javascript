...
type ActivityHistory = any;
type AdditionalContactDetails = any;
type ApefaceApiError = any;
type AppliedFilters = any;
type ArticleAssignment = any;
type ArticleBrand = any;
type ArticleIdentifiers = any;
type ArticleMeta = any;
type ArticlePrice = any;
type BagArticle = any;
type BagArticleReturnConfig = any;
type BagBreakupValues = any;
type BagCurrentStatus = any;
type BagCurrStatus = any;
type BagFinancialBreakup = any;
type BagItem = any;
type BagItemAttributes = any;
type BagPrices = any;
type Bags = any;
type BagsDetails = any;
type BagStateMapper = any;
type BagStatus = any;
type BagStatusBagStateMapper = any;
type BillingAddress = any;
type CanBreakRequestBody = any;
type CanBreakResponse = any;
type Channel = any;
type Closing = any;
type Company = any;
type Customer = any;
type Damaged = any;
type DataShipmentAddress = any;
type DefaultAddress = any;
type Dimension = any;
type Documents = any;
type DpDetails = any;
type FailedOrders = any;
type FailOrder = any;
type FailOrderDateMeta = any;
type Filters = any;
type FulfillingStoreMeta = any;
type FulfillingStoreStoreAddressJson = any;
type GetActivityStatus = any;
type GetClickToCallResponse = any;
type GetPingResponse = any;
type GetShipmentAddressResponse = any;
type GetVoiceCallbackResponse = any;
type Gst = any;
type GstDetails = any;
type Identifiers = any;
type ItemsPayments = any;
type ItemTotal = any;
type LineItems = any;
type LineItemsArticle = any;
type LineItemsArticleIdentifier = any;
type Manufacturer = any;
type MarketplaceIdentifiers = any;
type MarketplaceOrder = any;
type NotAvailable = any;
type Opening = any;
type Options = any;
type OrderCommitted = any;
type OrderDetails = any;
type OrderDetailsItem = any;
type OrderItems = any;
type OrderLanesCount = any;
type OrderListing = any;
type OrderPicklistListing = any;
type OrderShippingAddress = any;
type Payments = any;
type PlatformApplication = any;
type PlatformBreakupValues = any;
type PlatformDeliveryAddress = any;
type PlatformFulfillingStore = any;
type PlatformOrderDetailsPage = any;
type PlatformOrderPage = any;
type PlatformOrderTrack = any;
type PlatformOrderUserInfo = any;
type PlatformShipment = any;
type PlatformShipmentDetails = any;
type PlatformShipmentDetailsBrand = any;
type PlatformShipmentDetailsStatus = any;
type PlatformShipmentStatus = any;
type PlatformShipmentTrack = any;
type PresentmentMoney = any;
type PriceSet = any;
type PriceSetPresentmentMoney = any;
type PriceSetShopMoney = any;
type ProductReturnConfig = any;
type Promise = any;
type Quantities = any;
type Results = any;
type RtoAddress = any;
type Sellable = any;
type Set = any;
type SetSizeDistribution = any;
type ShipmentBreakupValues = any;
type ShipmentDates = any;
type ShipmentGst = any;
type ShipmentInvoice = any;
type ShipmentPrices = any;
type ShipmentReasonsResponse = any;
type ShipmentResponseReasons = any;
type ShipmentTrackingDetails = any;
type ShipmentTrackResponse = any;
type ShipmentTrackResponseBagListItem = any;
type ShipmentTrackResponseBagListItemBreakValues = any;
type ShipmentTrackResponseBagListItemDpDetails = any;
type ShipmentTrackResponseBagListItemsProductImage = any;
type ShipmentTrackResponseBagListItemStatuses = any;
type ShipmentTrackResponseBagListItemStatusesProgress = any;
type ShipmentTrackResponseBagListItemStatusesTrack = any;
type ShipmentUpdateRequest = any;
type ShipmentUpdateResponse = any;
type ShopMoney = any;
type Sizes = any;
type Stage = any;
type StageItem = any;
type Stages = any;
type StagesFilters = any;
type Store = any;
type StoreAddressJson = any;
type SubtotalPriceSet = any;
type SubtotalPriceSetPresentmentMoney = any;
type SubtotalPriceSetShopMoney = any;
type TatacliqLuxury = any;
type TaxLines = any;
type TaxLinesPriceSet = any;
type TaxLinesPriceSetPresentmentMoney = any;
type TaxLinesPriceSetShopMoney = any;
type Timestamp = any;
type Timing = any;
type TotalDiscountSet = any;
type TotalDiscountSetPresentmentMoney = any;
type TotalDiscountSetShopMoney = any;
type TotalDiscountsSet = any;
type TotalLineItemsPriceSet = any;
type TotalLineItemsPriceSetPresentmentMoney = any;
type TotalLineItemsPriceSetShopMoney = any;
type TotalPriceSet = any;
type TotalPriceSetPresentmentMoney = any;
type TotalPriceSetShopMoney = any;
type TotalShippingPriceSet = any;
type TotalShippingPriceSetPresentmentMoney = any;
type TotalShippingPriceSetShopMoney = any;
type TotalTaxSet = any;
type TotalTaxSetPresentmentMoney = any;
type TotalTaxSetShopMoney = any;
type UpdateOrderReprocessResponse = any;
type UpdateProcessShipmenstRequestBody = any;
type UpdateProcessShipmenstRequestResponse = any;
type UpdateShipmentAddressRequest = any;
type UpdateShipmentAddressResponse = any;
type UpdateShipmentStatusBody = any;
type UpdateShipmentStatusResponse = any;
type Weight = any;
...
type ApplicationItemResponse = any;
...
type CollectionItemRequest = any;
...
type Hierarchy = any;
type HsnCode = any;
type HsnCodesListingResponse = any;
...
type InvSize = any;
type ItemQuery = any;
type ItemQueryForUserCollection = any;
type Items = any;
...
type ProductCreateUpdate = any;
type ProductDetail = any;
type ProductDetailAttribute = any;
type ProductDetailGroupedAttribute = any;
type ProductDownloadItemsData = any;
type ProductDownloadsItems = any;
...
type _ArticleAssignment = any;
type _ArticleQuery = any;
type _AssignStoreArticle = any;
type AssignStoreRequestValidator = any;
type AssignStoreResponseSerializer = any;

...
type AutocompleteAction1 = any;
type AutocompletePageAction = any;
type AutocompletePageAction1 = any;
type AutocompleteResult = any;
type AutocompleteResult1 = any;
type BannerImage = any;
type BaseErrorResponse = any;
type BoostBury = any;
type BoostBury1 = any;
type BrandItem = any;
...
type CollectionErrorResponse = any;
...
type CollectionUpdateBanner = any;
type CollectionUpdateImage = any;
type CollectionUpdateResponse = any;
...
type CreateSearchReranking = any;
type CrossSellingDataResponse = any;
type CustomOrder = any;
type DefaultKeyRequest = any;
type DeleteRerankResponse = any;
type DeleteResponse = any;
type Department = any;
type DepartmentCategoryTree = any;
type DepartmentCreateError = any;
type DepartmentIdentifier = any;
type DepartmentListResponse = any;
type DepartmentModel = any;
type DepartmentPageResponse = any;
...
type RerankingAttribute = any;
type RerankingAttribute1 = any;
type ReturnConfig2 = any;
type ReturnConfigResponse = any;
type SearchErrorResponse = any;
type SearchKeywordResult = any;
type SearchKeywordResult1 = any;
type SearchRerankingModel = any;
type SearchRerankListing = any;
...
type Trader1 = any;
type Trader2 = any;
type UpdateAutocompleteWordData = any;

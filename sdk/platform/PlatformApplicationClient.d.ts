...
type AdvanceSettingV2 = any;
type AllAvailablePageSchema = any;
type AllThemesApplicationResponseV2 = any;
type ApplyThemeRequestV2 = any;
type ApplyThemeResponseV2 = any;
type ArrayOfMarketplaceTheme = any;
type AssetsSchema = any;
type AssetsV2 = any;
type AuthConfigV2 = any;
...
type BlockPropsV2 = any;
type Blocks = any;
type BlocksProps = any;
type BlockV2 = any;
type Bold = any;
type ButtonSettingV2 = any;
type CarouselItem = any;
type CatalogSize = any;
type CheckboxPropV2 = any;
type Colors = any;
type ColorsV2 = any;
type Comments = any;
type CommonJs = any;
...
type Config = any;
type ConfigPage = any;
type ConfigurationV2 = any;
type ConfigV2 = any;
type ContactInfo = any;
type Css = any;
type CSS = any;
type Custom = any;
type CustomConfigV2 = any;
type CustomPropsV2 = any;
type DividerStrokeHighlightSettingV2 = any;
type Documentation = any;
type ExploreInfo = any;
type Feature = any;
type FeatureItem = any;
type Font = any;
type FontsSchema = any;
type FontsSchemaItems = any;
type FontsSchemaItemsFiles = any;
type FontV2 = any;
type FontVariantsV2 = any;
type FontVariantV2 = any;
type FooterSettingV2 = any;
type GeneralSettingV2 = any;
type GlobalConfigV2 = any;
type GlobalSchema = any;
type GlobalSchemaProps = any;
type GlobalSchemaV2 = any;
type HeaderSettingV2 = any;
type Highlight = any;
type ImagePickerPropV2 = any;
type Images = any;
type ImagesV2 = any;
type Information = any;
type Light = any;
type ListSchemaItem = any;
type MarketplaceTheme = any;
type MarketplaceThemeId = any;
type MarketplaceThemeImages = any;
type MarketplaceThemeResponse = any;
type MarketplaceThemeResponseBody = any;
type Medium = any;
type MetaV2 = any;
type Organization = any;
type OrganizationMeta = any;
type OverlayPopupSettingV2 = any;
type PageV2 = any;
type PaginationSchema = any;
type PaletteConfigV2 = any;
type PaymentInfo = any;
type PaymentV2 = any;
type PredicateV2 = any;
type Preset = any;
type PresetV2 = any;
type PropV2 = any;
type RangePropV2 = any;
type Regular = any;
type RejectionReason = any;
type Release = any;
type ReleaseV2 = any;
type RouteV2 = any;
type SaleDiscountSettingV2 = any;
type ScreenV2 = any;
type SectionItem = any;
type SectionPresetV2 = any;
type SectionPropsV2 = any;
type Sections = any;
type SectionV2 = any;
type SemiBold = any;
type Src = any;
type StaticConfigV2 = any;
type StaticPropsV2 = any;
type TextPropV2 = any;
type TextSettingV2 = any;
type ThemeAndUserDetailsResponse = any;
type ThemeCreateRequest = any;
type ThemeCreator = any;
type ThemeImages = any;
type ThemeMeta = any;
type ThemePayment = any;
type ThemeRejectionReasons = any;
type ThemeReq = any;
type ThemeReviewRequest = any;
type ThemeSchema = any;
type ThemeSettingV2 = any;
type ThemesListingResponseSchema = any;
type ThemeSlugResponse = any;
type ThemesSchema = any;
type ThemeUpgradableResponseV2 = any;
type ThemeVersionsV2 = any;
type UmdJs = any;
type UMDJs = any;
type UpdateReviewStatusRequest = any;
type UpdateThemeNameRequestBodyV2 = any;
type UpdateThemeRequestBodyV2 = any;
type UpgradableThemeSchema = any;
type UrlPropV2 = any;
type UserAlertsSettingV2 = any;
type UserV2 = any;
type Variants = any;
type Variation = any;
type Accountkit = any;
...
type ApikeyValidatorError = any;
type ApikeyValidatorErrorMessage = any;
type AppProvider = any;
type AppProviderAdmin = any;
type AppProviderAdminObj = any;
type AppProviderReq = any;
type AppProviderRes = any;
type AppProviderResObj = any;
type AppProviderResVoice = any;
type Audience = any;
...
type CastToStringFail = any;
type DefaultEmailProviders = any;
type DefaultEmailProvidersObjFrom = any;
type DefaultSmsProviders = any;
type EmailProvider = any;
type EmailProviderAdmin = any;
type EmailProviderReq = any;
type EmailProviderReqFrom = any;
type EmailProviders = any;
type EmailProvidersAdmin = any;
...
type FeedidValidatorError = any;
type FeedidValidatorErrorMessage = any;
type GenericSuccess = any;
type GetNRecordsCsvReq = any;
type GetNRecordsCsvRes = any;
type GetNRecordsCsvResItems = any;
type GetStats = any;
type GlobalProviders = any;
type GlobalProvidersResObj = any;
type InvalidID = any;
type InvalidInputRequiredByteOrHexError = any;
type InvalidRangeErrorReqPositive = any;
type Job = any;
type JobLog = any;
type JobLogs = any;
type Jobs = any;
...
type NameValidatorError = any;
type NameValidatorErrorMessage = any;
type Notification = any;
type PasswordValidatorError = any;
type PasswordValidatorErrorMessage = any;
...
type SmsProviderAdmin = any;
type SmsProviderReq = any;
type SmsProviders = any;
type SmsProvidersAdmin = any;
...
type SystemVoiceTemplate = any;
type SystemVoiceTemplates = any;
type TemplateAndType = any;
type TriggerJobRequest = any;
type TriggerJobResponse = any;
type UpdateGlobalProviders = any;
type UpdateGlobalProvidersObj = any;
type UsernameValidatorError = any;
type UsernameValidatorErrorMessage = any;
type ValidatorErrorBody = any;
type ValidatorErrorMessageProperties = any;
type VerifyOtpCommsErrorRes = any;
type VerifyOtpCommsReq = any;
type VerifyOtpCommsSuccessRes = any;
type VoiceProvider = any;
type VoiceProviderReq = any;
type VoiceProviders = any;
type VoiceTemplate = any;
type VoiceTemplateDeleteFailureRes = any;
type VoiceTemplateDeleteSuccessRes = any;
type VoiceTemplateMessage = any;
type VoiceTemplateReq = any;
type VoiceTemplateRes = any;
type VoiceTemplates = any;
...
type ExtensionPaymentUpdateRequestSerializer = any;
type ExtensionPaymentUpdateResponseSerializer = any;
...
type FilterInfoOption1 = any;
type Filters = any;
type FiltersInfo = any;
type FiltersInfo1 = any;
type FiltersRequest = any;
...
type JioCodeUpsertDataSet = any;
type JioCodeUpsertPayload = any;
type JioCodeUpsertResponse = any;
type LaneConfigResponse = any;
type LineItem = any;
type LockData = any;
type Manifest = any;
type ManifestDetails = any;
type ManifestFile = any;
type ManifestFiltersResponse = any;
type ManifestItemDetails = any;
type ManifestList = any;
type ManifestMediaUpdate = any;
type ManifestMeta = any;
type ManifestPageInfo = any;
type ManifestShipmentListing = any;
type Meta = any;
type MetricCountResponse = any;
type MetricsCount = any;
type NestedErrorSchemaDataSet = any;
type OmsReports = any;
type Options = any;
...
type ProcessManifest = any;
type ProcessManifestItemResponse = any;
type ProcessManifestResponse = any;
type Products = any;
...
type ResponseGetAssetShipment = any;
...
type TaxDetails = any;
type TaxInfo = any;
type TotalShipmentPricesCount = any;
...
type Child = any;
type CollectionActionPage = any;
type CollectionActionPageQuery = any;
type CollectionBadge = any;
type CollectionBadge1 = any;
...
type CollectionSchedule1 = any;
type CollectionScheduleStartEnd = any;
...
type CartDynamicInjection = any;
type CartDynamicInjectionAdd = any;
type CartDynamicInjectionResponse = any;
type CartDynamicInjectionUpdate = any;
type CartItem = any;
...
type BulkRecordError = any;
type BulkRegionData = any;
type BulkRegionJobSerializer = any;
...
type GetBulkRegionJobResponse = any;
...
type PostBulkRegionJobResponse = any;

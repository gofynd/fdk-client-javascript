...
type EventCountItem = any;
type EventProcessedSuccessResponse = any;
type EventProcessReportObject = any;
type EventProcessReports = any;
type EventProcessRequest = any;
type EventSuccessResponse = any;
type FailedEventsCountSuccessResponse = any;
type FilterResponseObject = any;
type FilterValues = any;
type HistoryFilters = any;
type HistoryPayload = any;
type HistoryResponse = any;
type HistoryResponseObject = any;
type ManualRetryFailedResponse = any;
type PingWebhook = any;
type PingWebhookResponse = any;
type ReportFilterResponse = any;
type ReportFiltersPayload = any;
type RetryStatusResponse = any;
type SubscriberConfig = any;
type SubscriberConfigList = any;
type SubscriberResponse = any;
type UploadServiceObject = any;
type Url = any;

...
type BulkUploadSyncMode = any;
type CDN = any;
type companyDetail = any;
type CompleteResponse = any;
type CopyFiles = any;
type CopyFilesWithRewrite = any;
type CopyFileTask = any;
type customerBillingDetail = any;
type customerShippingDetail = any;
type DbRecord = any;
type Destination = any;
type DestinationBasepath = any;
type DestinationNamespace = any;
type DummyTemplateDataItems = any;
type DummyTemplateDataPayload = any;
type DummyTemplateDataPayloadImage = any;
type FailedResponse = any;
type File = any;
type FileSrc = any;
type FilesSuccess = any;
type invoiceDetail = any;
type InvoiceTypesResponse = any;
type Opts = any;
type payments = any;
type pdfConfig = any;
type pdfRender = any;
type Products = any;
type productTable = any;
type registeredCompanyDetail = any;
type returnDetail = any;

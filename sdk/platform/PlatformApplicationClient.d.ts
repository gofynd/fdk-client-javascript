...
type ProductTemplateCategory = any;
...
type BadRequestResponseGenerateBulk = any;
type BadRequestResponseGenerateBulkItem = any;
type BadRequestResponseGenerateBulkItemParameters = any;
type BadRequestResponseGenerateBulkUrl = any;
type BoxDetails = any;
type BulkListBadRequestResponse = any;
type BulkListFailedResponse = any;
type BulkPresignedSuccessResponse = any;
type DocumentType = any;
type GenerateBulkBoxLabel = any;
type GenerateBulkInvoiceLabelShipment = any;
type GenerateBulkInvoiceOrLabelUrl = any;
type GenerateBulkPackageLabel = any;
type GenerateBulkShipment = any;
type GenerateBulkShipmentLabel = any;
type GenerateBulkUrl = any;
type GenerateBulkUrlSuccessResponse = any;
type GenerateManifest = any;
type GenerateManifestUrlSuccessResponse = any;
type GenerateNoc = any;
type GeneratePresignedManifestUrl = any;
type GetBulkStatusRequest = any;
type InternalErrorResponseGenerateBulk = any;
type InternalErrorResponseGenerateBulkShipment = any;
type InternalErrorResponseGenerateBulkUrl = any;
type InvoiceLabelPresignedRequestBody = any;
type ManifestLink = any;
type ManifestListFailedResponse = any;
type PackageDetails = any;
type PackageItemDetails = any;
type SellerAddress = any;
type ShippingToAddress = any;
type SignedBadRequestResponse = any;
type SignedFailedResponse = any;
type SignedSuccessResponse = any;
type StatusBadRequestResponse = any;
type StatusFailedResponse = any;
type StatusSuccessResponse = any;
type SuccessResponseBulkStatus = any;
type SuccessResponseGenerateBulk = any;
type SuccessResponseGenerateBulkShipment = any;

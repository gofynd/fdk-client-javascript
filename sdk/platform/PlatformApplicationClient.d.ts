...
type Brand = any;
type BulkActionDetailsDataField = any;
type BulkActionDetailsResponse = any;
type BulkActionPayload = any;
type BulkActionResponse = any;
type BulkInvoiceLabelResponse = any;
type BulkInvoicingResponse = any;
type bulkListingData = any;
type BulkListingPage = any;
type BulkListingResponse = any;
...
type EinvoiceResponseData = any;
type EInvoiceRetry = any;
type EInvoiceRetryResponse = any;
type EInvoiceRetryShipmentData = any;
type Entities = any;
...
type LineItem = any;
type LockData = any;
type ManualAssignDPToShipment = any;
type ManualAssignDPToShipmentResponse = any;
...
type StoreAssign = any;
type StoreAssignError = any;
...
type AbandonedCartResponseSchema = any;
...
type AppliedFreeArticlesSchema = any;
type AppliedPromotion = any;
type ApplyCouponRequest = any;
type ArticleGiftDetailSchema = any;
type ArticlePriceInfo = any;
type BaseInfo = any;
type BasePriceSchema = any;
type BulkBundleRestriction = any;
type BuyRulesSchema = any;
type CartBreakupSchema = any;
type CartCheckoutResponseSchema = any;
type CartCurrencySchema = any;
type CartDeliveryModesResponse = any;
type CartDetailResponse = any;
type CartItemCountResponse = any;
type CartItemMeta = any;
type CartItemSchema = any;
type CartListSchema = any;
...
type CheckCartSchema = any;
type CompareObjectSchema = any;
type Coupon = any;
type CouponActionSchema = any;
type CouponAddSchema = any;
type CouponAuthorSchema = any;
type CouponBreakupSchema = any;
type CouponDateMetaSchema = any;
type CouponDetails = any;
type CouponPartialUpdate = any;
type CouponScheduleSchema = any;
type CouponsResponse = any;
type CouponUpdateSchema = any;
type CouponValidity = any;
type DeleteAddressResponse = any;
type DeleteCartDetailResponse = any;
type DeleteCartRequest = any;
type DiscountOfferSchema = any;
type DiscountRulesAppSchema = any;
type DiscountRuleSchema = any;
type DisplayBreakupSchema = any;
type DisplayMetaDictSchema = any;
type DisplayMetaSchema = any;
type DisplayMetaSchema1 = any;
type FilesSchema = any;
type FreeGiftItemSchema = any;
type GeoLocation = any;
type GetCouponResponse = any;
type GetShareCartLinkRequest = any;
type GetShareCartLinkResponse = any;
type GiftDetailSchema = any;
type IdentifierSchema = any;
type ItemCriteriaSchema = any;
type LoyaltyPoints = any;
type MultiCartResponseSchema = any;
...
type OpenApiFilesSchema = any;
type OpenApiOrderItemSchema = any;
type OpenApiPlatformCheckoutReqSchema = any;
type OperationErrorResponse = any;
type Ownership = any;
type OwnershipSchema = any;
type OwnershipSchema1 = any;
type PageCouponSchema = any;
type PaymentAllowValueSchema = any;
type PaymentAllowValueSchema1 = any;
type PaymentCouponValidateSchema = any;
type PaymentMetaSchema = any;
type PaymentMethodSchema = any;
type PaymentModesSchema = any;
...
type PostOrderSchema = any;
type PostOrderSchema1 = any;
type PriceRangeSchema = any;
...
type PromoMeta = any;
type PromotionActionSchema = any;
type PromotionAddSchema = any;
type PromotionAuthorSchema = any;
type PromotionDateMetaSchema = any;
type PromotionListItem = any;
type PromotionPartialUpdate = any;
type PromotionPaymentModesSchema = any;
type PromotionScheduleSchema = any;
type PromotionsResponse = any;
type PromotionUpdateSchema = any;
type RawBreakupSchema = any;
type RestrictionsSchema = any;
type RestrictionsSchema1 = any;
type RuleDefinitionSchema = any;
type RuleSchema = any;
...
type ShippingAddressSchema = any;
type StaffCheckoutSchema = any;
type StateSchema = any;
...
type UserInfoSchema = any;
type UserRegisteredSchema = any;
type UsesRemainingSchema = any;
type UsesRemainingSchema1 = any;
type UsesRestrictionSchema = any;
type UsesRestrictionSchema1 = any;
type ValidationSchema = any;
type ValiditySchema = any;
type VisibilitySchema = any;
type AppUser = any;

...
declare class CatalogModel {
    ...
    static AutocompleteResult1(): any;
    static BannerImage(): any;
    static BaseErrorResponse(): any;
    static BoostBury(): any;
    static BoostBury1(): any;
    static Brand(): any;
    ...
    static CollectionErrorResponse(): any;
    ...
    static CollectionUpdateBanner(): any;
    static CollectionUpdateImage(): any;
    ...
    static RerankingAttribute(): any;
    static RerankingAttribute1(): any;
    static ReturnConfig(): any;
    static ReturnConfig1(): any;
    static ReturnConfig2(): any;
    static ReturnConfigResponse(): any;
    static SearchErrorResponse(): any;
    static SearchKeywordResult(): any;
    static SearchKeywordResult1(): any;
    static SearchRerankingModel(): any;
    static SearchRerankListing(): any;
    ...
    static Trader1(): any;
    static Trader2(): any;
    static UpdateAutocompleteWordData(): any;

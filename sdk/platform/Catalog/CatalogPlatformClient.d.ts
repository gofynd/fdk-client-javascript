...
declare class Catalog {
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<SuccessResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    allSizes({ itemId }?: {
        itemId: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<GetAllSizes>;
    /**
     * @param {Object} arg - Arg object.
    ...
    bulkHsnCode({ body }?: {
        body: BulkHsnUpsert;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<BulkHsnResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    createBulkInventoryJob({ body }?: {
        body: BulkJob;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<BulkResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {BulkJob} arg.body
     * @param {import("../PlatformAPIClient").Options} - Options
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<CategoryCreateResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<DepartmentCreateResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventoryExportResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<UpdatedResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<GetProductBundleCreateResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductDownloadsResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventoryUpdateResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    deleteSize({ itemId, size }?: {
        itemId: number;
        size: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductSizeDeleteResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    exportInventoryConfig({ filterType }?: {
        filterType?: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventoryConfig>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getAllProductHsnCodes({ pageNo, pageSize, q, type }?: {
        ...
        q?: string;
        type?: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<HsnCodesListingResponseSchemaV2>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getCategoryData({ uid }?: {
        uid: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<SingleCategoryResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getCompanyBrandDetail({ isActive, q, pageNo, pageSize, marketplace }?: {
        ...
        pageSize?: number;
        marketplace?: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<OptinCompanyBrandDetailsView>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     ...
     */
    getCompanyDetail({ headers }?: any): Promise<OptinCompanyDetail>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     ...
     */
    getCompanyMetrics({ headers }?: any): Promise<OptinCompanyMetrics>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getDepartmentData({ uid }?: {
        uid: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<DepartmentsResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<GenderDetail>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getHsnCode({ id }?: {
        id: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<HsnCode>;
    /**
     * @param {Object} arg - Arg object.
    ...
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<GetInventoriesResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {number} [arg.pageNo] - The page number to navigate through the
     *   given set of results
    ...
    getInventoryBulkUploadHistory({ pageNo, pageSize }?: {
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<BulkInventoryGet>;
    /**
     * @param {Object} arg - Arg object.
     * @param {number} arg.itemId - Item code of the product of which size is to be get.
     * @param {string} arg.size - Size of which inventory is to get.
    ...
    getInventoryBySize({ itemId, size, pageNo, pageSize, q, sellable }?: {
        ...
        q?: string;
        sellable?: boolean;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventoryResponsePaginated>;
    /**
     * @param {Object} arg - Arg object.
     * @param {number} arg.itemId - Item code of the product of which size is to be get.
     * @param {string} arg.sizeIdentifier - Size Identifier (Seller Identifier
    ...
    getInventoryBySizeIdentifier({ itemId, sizeIdentifier, pageNo, pageSize, q, locationIds }?: {
        ...
        q?: string;
        locationIds?: number[];
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventorySellerIdentifierResponsePaginated>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     ...
     */
    getInventoryExport({ headers }?: any): Promise<InventoryExportJob>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     ...
     */
    getMarketplaceOptinDetail({ headers }?: any): Promise<GetOptInPlatform>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getOptimalLocations({ body }?: {
        body: AssignStore;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<StoreAssignResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProduct({ itemId, brandUid, itemCode }?: {
        ...
        brandUid?: number;
        itemCode?: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<SingleProductResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {number} [arg.pageNo] - The page number to navigate through the
     *   given set of results
    ...
    getProductAssetsInBulk({ pageNo, pageSize }?: {
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<BulkAssetResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProductAttributes({ category, filter }?: {
        category: string;
        filter?: boolean;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductAttributesResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProductBulkUploadHistory({ search, pageNo, pageSize }?: {
        ...
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductBulkRequestList>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProductBundle({ q, slug }?: {
        q?: string;
        slug?: string[];
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<GetProductBundleListingResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProductBundleDetail({ id }?: {
        id: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<GetProductBundleResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProductSize({ itemId, itemCode, brandUid, uid }?: {
        ...
        brandUid?: number;
        uid?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductListingResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     ...
     */
    getProductTags({ headers }?: any): Promise<ProductTagsViewResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     ...
     */
    getProductValidation({ headers }?: any): Promise<ValidateProduct>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getProducts({ brandIds, categoryIds, itemIds, departmentIds, itemCode, q, tags, pageNo, pageSize, }?: {
        ...
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductListingResponseV2>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getSellerInsights({ sellerAppId }?: {
        sellerAppId: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<CrossSellingResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getSingleProductHSNCode({ reportingHsn }?: {
        reportingHsn: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<HSNDataInsertV2>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getSizeGuide({ id }?: {
        id: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<SizeGuideResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getSizeGuides({ active, q, tag, pageNo, pageSize }?: {
        ...
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ListSizeGuide>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getStoreDetail({ q, pageNo, pageSize }?: {
        ...
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<OptinStoreDetails>;
    /**
     * @param {Object} arg - Arg object.
    ...
    getVariantsOfProducts({ itemId, variantType, pageNo, pageSize }?: {
        ...
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductVariantsResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    listCategories({ level, departments, q, pageNo, pageSize }?: {
        ...
        pageNo?: number;
        pageSize?: number;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<CategoryResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {number} [arg.pageNo] - The page number to navigate through the
     *   given set of results
     ...
     */
    listHSNCodes({ headers }?: any): Promise<HSNCodesResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    listInventoryExport({ status, fromDate, toDate, q }?: {
        ...
        toDate?: string;
        q?: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventoryExportJobListResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    listProductTemplate({ department }?: {
        department: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<TemplatesResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    listProductTemplateCategories({ departments, itemType }?: {
        departments: string;
        itemType: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProdcutTemplateCategoriesResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {import("../PlatformAPIClient").Options} - Options
     * @returns {Promise<ProductDownloadsResponse>} - Success response
     ...
     * @description: Can view details including trigger data, task id , etc.
     */
    listProductTemplateExportDetails({ headers }?: any): Promise<ProductDownloadsResponse>;
    /**
     * @param {Object} arg - Arg object.
    ...
    listTemplateBrandTypeValues({ filter, templateTag, itemType }?: {
        ...
        templateTag?: string;
        itemType?: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<ProductConfigurationDownloads>;
    /**
     * @param {Object} arg - Arg object.
     * @param {string} arg.uid - Category unique id
     * @param {CategoryRequestBody} arg.body
    ...
    updateCategory({ uid, body }?: {
        uid: string;
        body: CategoryRequestBody;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<CategoryUpdateResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {string} arg.uid - A `uid` is a unique identifier of a department.
     * @param {DepartmentCreateUpdate} arg.body
    ...
    updateDepartment({ uid, body }?: {
        uid: string;
        body: DepartmentCreateUpdate;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<DepartmentModel>;
    /**
     * @param {Object} arg - Arg object.
     * @param {string} arg.id - Unique id
    ...
    validateProductTemplate({ slug, itemType, bulk }?: {
        ...
        itemType?: string;
        bulk?: boolean;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<TemplatesValidationResponse>;
    /**
     * @param {Object} arg - Arg object.
     * @param {string} arg.itemType - An `item_type` defines the type of item.
     *   The default value is standard.
    ...
    validateProductTemplateSchema({ itemType }?: {
        itemType: string;
    }, { headers }?: import("../PlatformAPIClient").Options): Promise<InventoryValidationResponse>;
}

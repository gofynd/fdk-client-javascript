...
declare class Catalog {
     ...
     */
    deleteRealtimeInventory({ itemId, sellerIdentifier, body }?: CatalogPlatformValidator.DeleteRealtimeInventoryParam): Promise<CatalogPlatformModel.InventoryUpdateResponse>;
    /**
     ...
     */
    downloadProductTemplateViews({ slug, itemType, type }?: CatalogPlatformValidator.DownloadProductTemplateViewsParam): Promise<string>;
    /**
     ...
     */
    validateProductTemplate({ slug, itemType, bulk }?: CatalogPlatformValidator.ValidateProductTemplateParam): Promise<CatalogPlatformModel.TemplatesValidationResponse>;
    /**

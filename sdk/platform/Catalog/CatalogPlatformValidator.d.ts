...
declare class CatalogValidator {
    ...
    static listAllProductTemplateExportDetails(): any;
    static createProductExportJob(): any;
    static updateProductExportJob(): any;
    static getProductTemplateExportDetail(): any;
    ...
    static updateInventoryExportJob(): any;
    static getInventoryExportJobDetail(): any;

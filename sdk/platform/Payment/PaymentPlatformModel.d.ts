...
type CartDetailsSerializer = {
    ...
    cart_value: number;
    /**
     * - Contains all the charges
     * that are applicable on cart
     */
    cart_charges?: CartChargesSerializer[];
    /**

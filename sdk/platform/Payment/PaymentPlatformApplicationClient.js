...
class Payment {
  ...
  async copyConfigAggPaymentModes(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.AggregatorConfigDetails().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async deleteBeneficiaryDetails(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.DeleteRefundAccountDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getAggregatorCredential(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.AggregatorCredentialRes().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async getAggregatorCredentialHistory(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.AggregatorHistoryDetails().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async getBankAccountDetailsOpenAPI(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.GetRefundAccountDetails().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async getDevices(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.GetDevice().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async getMerchantAggregatorPaymentModeDetails(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.AggregatorPlatformPaymentModeDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getMerchantPaymentOption(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.PlatformOnlineOfflinePaymentDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getPaymentModeControlRoutes(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.PlatformOfflineAdvanceDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getPaymentModeRoutes(
    { amount, refresh, requestType, orderId, shipmentId, requestHeaders } = {
      requestHeaders: {},
    },
    { responseHeaders } = { responseHeaders: false }
  ) {
  ...
  async getPaymentModeSequencing(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.PaymentModeDetails().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async getPaymentSession(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.GetPaymentSessionDetails().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async getPennyDropValidation(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.PennyDropValidationDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getSelectedRefundOption(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.SelectedRefundOptionDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async getShipmentBeneficiary(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.ShipmentBeneficiaryDetailsRes().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async patchMerchantPaymentOption(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.PatchPlatformOnlineOfflinePaymentDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async setRefundOptionforShipment(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.ShipmentRefundRes().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
  ...
  async updateAggregatorCredential(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.PatchAggregatorCredentialDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async updateDefaultBeneficiary(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.SetDefaultBeneficiaryDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
  ...
  async validateBeneficiaryAddress(
    ...
    const {
      error: res_error,
    } = PaymentPlatformModel.ValidateValidateAddressDetails().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );

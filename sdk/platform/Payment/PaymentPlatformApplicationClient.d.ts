...
declare class Payment {
     ...
     */
    getMerchantAggregatorPaymentModeDetails({ aggregatorId, businessUnit, device, }?: PaymentPlatformApplicationValidator.GetMerchantAggregatorPaymentModeDetailsParam): Promise<PaymentPlatformModel.MerchnatPaymentModeResponse>;
    /**
     ...
     */
    getMerchantPaymentOption({}?: any): Promise<PaymentPlatformModel.MerchnatPaymentModeResponse>;
    /**
     ...
     */
    getPGConfigAggregators({}?: any): Promise<PaymentPlatformModel.MerchnatPaymentModeResponse>;
    /**
     ...
     */
    patchMerchantAggregatorPaymentModeDetails({ aggregatorId, body }?: PaymentPlatformApplicationValidator.PatchMerchantAggregatorPaymentModeDetailsParam): Promise<PaymentPlatformModel.MerchnatPaymentModeResponse>;
    /**
     ...
     */
    patchMerchantPaymentOption({ body }?: PaymentPlatformApplicationValidator.PatchMerchantPaymentOptionParam): Promise<PaymentPlatformModel.MerchnatPaymentModeResponse>;
    /**
     ...
     */
    updatePaymentSession({ gid, body }?: PaymentPlatformApplicationValidator.UpdatePaymentSessionParam): Promise<PaymentPlatformModel.PaymentSessionResponseSerializer>;
    /**
     ...
     */
    updateRefundSession({ gid, requestId, body }?: PaymentPlatformApplicationValidator.UpdateRefundSessionParam): Promise<PaymentPlatformModel.RefundSessionResponseSerializer>;
    /**

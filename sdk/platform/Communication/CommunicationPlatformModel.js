...
class CommunicationPlatformModel {
  ...
  static ApikeyValidatorError() {
    return Joi.object({
      message: CommunicationPlatformModel.ApikeyValidatorErrorMessage(),
  ...
  static ApikeyValidatorErrorMessage() {
    return Joi.object({
      api_key: CommunicationPlatformModel.ValidatorErrorBody(),
    });
  }
  ...
  static AppProviderAdmin() {
    return Joi.object({
      email: CommunicationPlatformModel.AppProviderAdminObj(),
      sms: CommunicationPlatformModel.AppProviderAdminObj(),
      voice: CommunicationPlatformModel.AppProviderAdminObj(),
    });
  }
  ...
  static DefaultEmailProviders() {
    return Joi.object({
      ...
      from_address: Joi.array().items(
        CommunicationPlatformModel.DefaultEmailProvidersObjFrom()
      ),
  ...
  static EmailTemplatesAdmin() {
    return Joi.object({
      items: Joi.array().items(CommunicationPlatformModel.EmailTemplateAdmin()),
      page: CommunicationPlatformModel.Page(),
    });
  }
  ...
  static FeedidValidatorError() {
    return Joi.object({
      message: CommunicationPlatformModel.FeedidValidatorErrorMessage(),
      sentry: Joi.string().allow(""),
    });
  }
  ...
  static FeedidValidatorErrorMessage() {
    return Joi.object({
      feedid: CommunicationPlatformModel.ValidatorErrorBody(),
    });
  }
  ...
  static NameValidatorError() {
    return Joi.object({
      message: CommunicationPlatformModel.NameValidatorErrorMessage(),
      sentry: Joi.string().allow(""),
    });
  }
  ...
  static NameValidatorErrorMessage() {
    return Joi.object({
      name: CommunicationPlatformModel.ValidatorErrorBody(),
    });
  }
  ...
  static PasswordValidatorError() {
    return Joi.object({
      message: CommunicationPlatformModel.PasswordValidatorErrorMessage(),
      sentry: Joi.string().allow(""),
    });
  }
  ...
  static PasswordValidatorErrorMessage() {
    return Joi.object({
      password: CommunicationPlatformModel.ValidatorErrorBody(),
    });
  }
  ...
  static SmsProvidersAdmin() {
    return Joi.object({
      items: Joi.array().items(CommunicationPlatformModel.SmsProviderAdmin()),
      page: CommunicationPlatformModel.Page(),
    });
  }
  ...
  static SmsTemplatesAdmin() {
    return Joi.object({
      items: Joi.array().items(CommunicationPlatformModel.SmsTemplateAdmin()),
      page: CommunicationPlatformModel.Page(),
    });
  }
  ...
  static SystemVoiceTemplate() {
    return Joi.object({
      ...
      is_internal: Joi.boolean(),
      is_system: Joi.boolean(),
      message: CommunicationPlatformModel.VoiceTemplateMessage(),
      name: Joi.string().allow(""),
      priority: Joi.string().allow(""),
      published: Joi.boolean(),
      slug: Joi.string().allow(""),
  ...
  static SystemVoiceTemplates() {
    return Joi.object({
      items: Joi.array().items(
        CommunicationPlatformModel.SystemVoiceTemplate()
      ),
      page: CommunicationPlatformModel.Page(),
    });
  }
  ...
  static UpdateGlobalProviders() {
    return Joi.object({
      ...
      _id: Joi.string().allow(""),
      created_at: Joi.string().allow(""),
      email: CommunicationPlatformModel.UpdateGlobalProvidersObj(),
      sms: CommunicationPlatformModel.UpdateGlobalProvidersObj(),
      updated_at: Joi.string().allow(""),
      voice: CommunicationPlatformModel.UpdateGlobalProvidersObj(),
    });
  }
  ...
  static UsernameValidatorError() {
    return Joi.object({
      message: CommunicationPlatformModel.UsernameValidatorErrorMessage(),
      sentry: Joi.string().allow(""),
    });
  }
  ...
  static UsernameValidatorErrorMessage() {
    return Joi.object({
      username: CommunicationPlatformModel.ValidatorErrorBody(),
    });
  }
  ...
  static ValidatorErrorBody() {
    return Joi.object({
      ...
      properties: CommunicationPlatformModel.ValidatorErrorMessageProperties(),
    });
  }
  ...
  static VoiceProviders() {
    return Joi.object({
      items: Joi.array().items(CommunicationPlatformModel.VoiceProvider()),
      page: CommunicationPlatformModel.Page(),
    });
  }
  ...
  static VoiceTemplates() {
    return Joi.object({
      items: Joi.array().items(CommunicationPlatformModel.VoiceTemplate()),
      page: CommunicationPlatformModel.Page(),
    });
  }
}

 ...
 */
/**
 * @typedef CreateThemePreviewBody
 * @property {number} [pincode] - Pincode.
 * @property {number} [user_group_uid] - Uid of the user group.
 * @property {string} [preview_date_time] - Date and Time for theme preview.
 * @property {string} [page] - Page value.
 */
/**
 * @typedef CreateThemePreviewResponseSchema
 * @property {boolean} [success] - Whether the preview entry created on not.
 * @property {string} [hash_key] - Hash key to required at the time of theme preview.
 */
/**
 * @typedef ActionPage
...
/** @returns {CreateThemePreviewBody} */
declare function CreateThemePreviewBody(): CreateThemePreviewBody;
type CreateThemePreviewBody = {
    /**
     * - Pincode.
     */
    pincode?: number;
    /**
     * - Uid of the user group.
     */
    user_group_uid?: number;
    /**
     * - Date and Time for theme preview.
     */
    preview_date_time?: string;
    /**
     * - Page value.
     */
    page?: string;
};
/** @returns {CreateThemePreviewResponseSchema} */
declare function CreateThemePreviewResponseSchema(): CreateThemePreviewResponseSchema;
type CreateThemePreviewResponseSchema = {
    /**
     * - Whether the preview entry created on not.
     */
    success?: boolean;
    /**
     * - Hash key to required at the time of theme preview.
     */
    hash_key?: string;
};
/** @returns {ActionPage} */

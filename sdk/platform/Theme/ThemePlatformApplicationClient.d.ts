...
declare class Theme {
     ...
     */
    createThemePreview({ themeId, body, requestHeaders }?: ThemePlatformApplicationValidator.CreateThemePreviewParam, { responseHeaders }?: object): Promise<ThemePlatformModel.CreateThemePreviewResponseSchema>;
    /**

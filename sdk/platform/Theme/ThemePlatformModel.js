...
class ThemePlatformModel {
  ...
  static AdvanceSettingV2() {
    return Joi.object({
      divider_stroke_highlight: ThemePlatformModel.DividerStrokeHighlightSettingV2(),
      overlay_popup: ThemePlatformModel.OverlayPopupSettingV2(),
      user_alerts: ThemePlatformModel.UserAlertsSettingV2(),
    });
  }
  ...
  static AllThemesApplicationResponseV2() {
    return Joi.object({
      ...
      applied: Joi.boolean(),
      assets: ThemePlatformModel.AssetsV2(),
      available_sections: Joi.array().items(ThemePlatformModel.SectionItem()),
      config: ThemePlatformModel.ConfigV2(),
      created_at: Joi.string().allow(""),
      font: ThemePlatformModel.FontV2(),
      is_private: Joi.boolean(),
      marketplace_theme_id: Joi.string().allow(""),
      meta: ThemePlatformModel.MetaV2(),
  ...
  static ArrayOfMarketplaceTheme() {
    return Joi.object({
      body: Joi.array().items(ThemePlatformModel.MarketplaceTheme()),
    });
  }
  ...
  static BlockPropsV2() {
    return Joi.object({
      image: ThemePlatformModel.ImagePickerPropV2(),
      slide_link: ThemePlatformModel.UrlPropV2(),
    });
  }
  ...
  static BlockV2() {
    return Joi.object({
      name: Joi.string().allow(""),
      props: ThemePlatformModel.BlockPropsV2(),
      type: Joi.string().allow(""),
    });
  }
  ...
  static ConfigurationV2() {
    return Joi.object({
      custom: ThemePlatformModel.CustomConfigV2(),
      global_config: ThemePlatformModel.GlobalConfigV2(),
      name: Joi.string().allow(""),
  ...
  static ConfigV2() {
    return Joi.object({
      ...
      global_schema: ThemePlatformModel.GlobalSchemaV2(),
      list: Joi.array().items(ThemePlatformModel.ConfigurationV2()).required(),
      preset: ThemePlatformModel.PresetV2(),
    });
  }
  ...
  static CustomConfigV2() {
    return Joi.object({
      props: ThemePlatformModel.CustomPropsV2(),
    });
  }
  ...
  static FontV2() {
    return Joi.object({
      ...
      variants: ThemePlatformModel.FontVariantsV2().required(),
    });
  }
  ...
  static FontVariantsV2() {
    return Joi.object({
      bold: ThemePlatformModel.FontVariantV2(),
      light: ThemePlatformModel.FontVariantV2(),
      medium: ThemePlatformModel.FontVariantV2(),
      regular: ThemePlatformModel.FontVariantV2(),
      semi_bold: ThemePlatformModel.FontVariantV2(),
    });
  }
  ...
  static GeneralSettingV2() {
    return Joi.object({
      button: ThemePlatformModel.ButtonSettingV2(),
      footer: ThemePlatformModel.FooterSettingV2(),
      header: ThemePlatformModel.HeaderSettingV2(),
      sale_discount: ThemePlatformModel.SaleDiscountSettingV2(),
      text: ThemePlatformModel.TextSettingV2(),
      theme: ThemePlatformModel.ThemeSettingV2(),
    });
  }
  ...
  static GlobalConfigV2() {
    return Joi.object({
      auth: ThemePlatformModel.AuthConfigV2(),
      palette: ThemePlatformModel.PaletteConfigV2(),
      statics: ThemePlatformModel.StaticConfigV2(),
    });
  }
  ...
  static GlobalSchemaV2() {
    return Joi.object({
      props: Joi.array().items(ThemePlatformModel.PropV2()),
    });
  }
  ...
  static MarketplaceThemeResponse() {
    return Joi.object({
      body: ThemePlatformModel.MarketplaceThemeResponseBody(),
      status: Joi.number(),
    });
  }
  ...
  static MarketplaceThemeResponseBody() {
    return Joi.object({
      ...
      themes: Joi.array().items(ThemePlatformModel.MarketplaceTheme()),
    });
  }
  ...
  static MetaV2() {
    return Joi.object({
      description: Joi.string().allow(""),
      images: ThemePlatformModel.ImagesV2(),
      industry: Joi.array().items(Joi.string().allow("")),
      name: Joi.string().allow(""),
      payment: ThemePlatformModel.PaymentV2(),
      release: ThemePlatformModel.ReleaseV2(),
      slug: Joi.string().allow(""),
    });
  }
  ...
  static Organization() {
    return Joi.object({
      _id: Joi.string().allow(""),
      meta: ThemePlatformModel.OrganizationMeta(),
    });
  }
  ...
  static PageV2() {
    return Joi.object({
      sections: Joi.array().items(ThemePlatformModel.SectionV2()),
      value: Joi.string().allow(""),
    });
  }
  ...
  static PaletteConfigV2() {
    return Joi.object({
      advance_setting: ThemePlatformModel.AdvanceSettingV2(),
      general_setting: ThemePlatformModel.GeneralSettingV2(),
    });
  }
  ...
  static PredicateV2() {
    return Joi.object({
      route: ThemePlatformModel.RouteV2(),
      screen: ThemePlatformModel.ScreenV2(),
      user: ThemePlatformModel.UserV2(),
    });
  }
  ...
  static PresetV2() {
    return Joi.object({
      pages: Joi.array().items(ThemePlatformModel.PageV2()),
    });
  }
  ...
  static SectionPresetV2() {
    return Joi.object({
      blocks: Joi.array().items(ThemePlatformModel.BlockV2()),
    });
  }
  ...
  static SectionPropsV2() {
    return Joi.object({
      autoplay: ThemePlatformModel.CheckboxPropV2(),
      item_margin: ThemePlatformModel.TextPropV2(),
      slide_interval: ThemePlatformModel.RangePropV2(),
      title: ThemePlatformModel.TextPropV2(),
    });
  }
  ...
  static SectionV2() {
    return Joi.object({
      blocks: Joi.array().items(ThemePlatformModel.BlockV2()),
      name: Joi.string().allow(""),
      predicate: ThemePlatformModel.PredicateV2(),
      preset: ThemePlatformModel.SectionPresetV2(),
      props: ThemePlatformModel.SectionPropsV2(),
    });
  }
  ...
  static StaticConfigV2() {
    return Joi.object({
      props: ThemePlatformModel.StaticPropsV2(),
    });
  }
  ...
  static StaticPropsV2() {
    return Joi.object({
      auth: ThemePlatformModel.AuthConfigV2(),
      colors: ThemePlatformModel.ColorsV2(),
    });
  }
  ...
  static ThemeAndUserDetailsResponse() {
    return Joi.object({
      themes: Joi.array().items(ThemePlatformModel.MarketplaceTheme()),
      user: Joi.array().items(ThemePlatformModel.ThemeCreator()),
    });
  }
  ...
  static ThemeCreator() {
    return Joi.object({
      ...
      active: Joi.boolean().required(),
      emails: Joi.array().items(ThemePlatformModel.Email()).required(),
      first_name: Joi.string().allow(""),
      gender: Joi.string().allow("").allow(null),
      last_name: Joi.string().allow(""),
      phone_numbers: Joi.array().items(ThemePlatformModel.PhoneNumber()),
    });
  }
  ...
  static ThemeSlugResponse() {
    return Joi.object({
      organization: ThemePlatformModel.Organization(),
      theme: ThemePlatformModel.MarketplaceTheme(),
      user: Joi.array().items(ThemePlatformModel.ThemeCreator()),
    });
  }
  ...
  static ThemeUpgradableResponseV2() {
    return Joi.object({
      message: Joi.string().allow(""),
      upgrade: Joi.boolean(),
      versions: ThemePlatformModel.ThemeVersionsV2(),
    });
  }

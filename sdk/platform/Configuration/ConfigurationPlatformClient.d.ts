...
declare class Configuration {
     ...
     */
    getLevelActiveIntegrations({ id, level, uid }?: ConfigurationPlatformValidator.GetLevelActiveIntegrationsParam): Promise<ConfigurationPlatformModel.OptedStoreIntegration>;
    /**

...
declare namespace ConfigurationPlatformModel {
    export { CurrencyExchangeResponseV2, CurrencyExchangeItem, ApplicationInventory, PiiMasking, OwnerAppInventoryConfig, OwnerAppConfig, AppInventoryConfig, InventoryBrand, InventoryStore, AppStoreRules, InventoryCategory, InventoryPrice, InventoryDiscount, AuthenticationConfig, ArticleAssignmentConfig, ArticleAssignmentRules, StorePriority, AppCartConfig, InternationalDeliveryCharges, DeliveryCharges, Charges, AppPaymentConfig, CallbackUrl, Methods, PaymentModeConfig, PaymentSelectionLock, AppOrderConfig, AppLogisticsConfig, LoyaltyPointsConfig, AppInventoryPartialUpdate, BrandCompanyInfo, CompanyByBrandsRequestSchema, CompanyByBrandsResponseSchema, StoreByBrandsRequestSchema, StoreByBrandsResponseSchema, BrandStoreInfo, CompanyBrandInfo, BrandsByCompanyResponseSchema, ValidationFailedResponseSchema, NotFound, CommunicationConfig, CommsConfig, PanCardConfig, CreateApplicationRequestSchema, CreateAppResponseSchema, ApplicationsResponseSchema, AppSupportedCurrency, DefaultCurrency, DomainAdd, DomainAddRequestSchema, Domain, DomainsResponseSchema, UpdateDomain, UpdateDomainTypeRequestSchema, DomainStatusRequestSchema, DomainStatus, DomainStatusResponseSchema, DomainSuggestionsRequestSchema, DomainSuggestion, DomainSuggestionsResponseSchema, SuccessMessageResponseSchema, GetIntegrationsOptInsResponseSchema, IntegrationOptIn, Validators, CompanyValidator, JsonSchema, StoreValidator, InventoryValidator, OrderValidator, IntegrationMeta, IntegrationLevel, UpdateIntegrationLevelRequestSchema, OptedStoreIntegration, OtherEntity, LastPatch, OtherEntityData, App, InventoryConfig, AppInventory, AppDomain, CompaniesResponseSchema, AppInventoryCompanies, StoresResponseSchema, ListStoreResponseSchemaSchema, AppInventoryStores, FilterOrderingStoreRequestSchemaSchema, DeploymentMeta, OrderingStoreConfig, OrderingStoreSelectRequestSchema, OrderingStoreSelect, OtherSellerCompany, OtherSellerApplication, OtherSellerApplications, OptedApplicationResponseSchema, DomainStoreInStoreConfig, ThemeStoreInStoreConfig, StoreInStoreConfig, OptedCompany, OptedInventory, OptType, OptedStore, OptOutInventory, TokenResponseSchema, Tokens, Firebase, Credentials, Ios, Android, Moengage, MoengageCredentials, Segment, SegmentCredentials, Gtm, GtmCredentials, Freshchat, FreshchatCredentials, Safetynet, SafetynetCredentials, FyndRewards, FyndRewardsCredentials, GoogleMap, GoogleMapCredentials, RewardPointsConfig, Credit, Debit, ProductDetailFeature, LaunchPage, LandingPageFeature, ListingPageFeature, RegistrationPageFeature, AppFeature, HomePageFeature, CommonFeature, InternationalShipping, CommunicationOptinDialogFeature, DeploymentStoreSelectionFeature, ListingPriceFeature, CurrencyFeature, RevenueEngineFeature, FeedbackFeature, CompareProductsFeature, CartFeature, QrFeature, PcrFeature, OrderFeature, BuyboxFeature, AppFeatureRequestSchema, AppFeatureResponseSchema, Currency, ApplicationWebsite, ApplicationCors, ApplicationAuth, ApplicationRedirections, ApplicationMeta, SecureUrl, Application, TokenSchema, InvalidPayloadRequestSchema, InventoryBrandRule, PricingStrategy, StoreCriteriaRule, InventoryStoreRule, InventoryPaymentConfig, StorePriorityRule, ArticleAssignmentRule, InventoryArticleAssignment, Page, ApplicationInformation, InformationAddress, InformationPhone, InformationLoc, InformationSupport, InformationSupportPhone, InformationSupportEmail, SocialLinks, FacebookLink, InstagramLink, TwitterLink, PinterestLink, GooglePlusLink, YoutubeLink, LinkedInLink, VimeoLink, BlogLink, Links, BusinessHighlights, ApplicationDetail, CurrenciesResponseSchema, AppCurrencyResponseSchema, StoreLatLong, OptedStoreAddress, OrderingStore, OrderingStores, UpdateDiealog, PlatformVersionRequestSchema, PlatformVersion, OrderingStoresResponseSchema, LocationDefaultLanguage, LocationDefaultCurrency, LocationCountry, Locations, UrlRedirectionResponseSchema, UrlRedirectionRequestSchema, UrlRedirection, StoreForConfigurationRequestSchema, DomainOptionsResponseSchema, DomainType, DomainValue, StoreRequestSchema, StoreResponseSchema, ValidationError };
}
...
type Domain = {
    ...
    name?: string;
    /**
     * - Display domain name, e.g. newton
     */
    display_name?: string;
    /**
     * - The unique identifier (24-digit Mongo Object ID)
...
type DomainSuggestionsRequestSchema = {
    ...
    domain_url?: string;
    /**
     * - Get suggestions for custom domains
     * or Fynd domains
     */
...
declare function GetIntegrationsOptInsResponseSchema(): GetIntegrationsOptInsResponseSchema;
type GetIntegrationsOptInsResponseSchema = {
...
declare function UpdateIntegrationLevelRequestSchema(): UpdateIntegrationLevelRequestSchema;
type UpdateIntegrationLevelRequestSchema = {
...
type AppDomain = {
    ...
    name?: string;
    /**
     * - Domain name of current sales channel, e.g. zenz
     */
    display_name?: string;
};
...
declare function ListStoreResponseSchemaSchema(): ListStoreResponseSchemaSchema;
type ListStoreResponseSchemaSchema = {
...
declare function FilterOrderingStoreRequestSchemaSchema(): FilterOrderingStoreRequestSchemaSchema;
type FilterOrderingStoreRequestSchemaSchema = {
    /**
...
declare function DomainStoreInStoreConfig(): DomainStoreInStoreConfig;
type DomainStoreInStoreConfig = {
    /**
     * - Name of the domain
     */
    domain_name?: string;
...
declare function ThemeStoreInStoreConfig(): ThemeStoreInStoreConfig;
type ThemeStoreInStoreConfig = {
    /**
     * - Name of the theme
     */
    theme_name?: string;
...
declare function StoreInStoreConfig(): StoreInStoreConfig;
type StoreInStoreConfig = {
    /**
     * - Name of the store
     */
    name?: string;
    domain?: DomainStoreInStoreConfig;
    theme?: ThemeStoreInStoreConfig;
    /**
     * - Application ID
     */
    app_id?: string;
    /**
     * - Archive status of the store
     */
    is_archive?: boolean;
};
...
declare function PlatformVersionRequestSchema(): PlatformVersionRequestSchema;
type PlatformVersionRequestSchema = {
...
declare function UrlRedirectionResponseSchema(): UrlRedirectionResponseSchema;
type UrlRedirectionResponseSchema = {
    redirections?: UrlRedirection[];
};
/** @returns {UrlRedirectionRequestSchema} */
declare function UrlRedirectionRequestSchema(): UrlRedirectionRequestSchema;
type UrlRedirectionRequestSchema = {
...
declare function StoreForConfigurationRequestSchema(): StoreForConfigurationRequestSchema;
type StoreForConfigurationRequestSchema = {
    conf?: AppStoreRules[];
};
/** @returns {DomainOptionsResponseSchema} */
declare function DomainOptionsResponseSchema(): DomainOptionsResponseSchema;
type DomainOptionsResponseSchema = {
...
declare function StoreRequestSchema(): StoreRequestSchema;
type StoreRequestSchema = {
    companies?: number[];
};
/** @returns {StoreResponseSchema} */
declare function StoreResponseSchema(): StoreResponseSchema;

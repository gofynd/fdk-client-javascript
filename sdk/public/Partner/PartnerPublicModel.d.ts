...
declare namespace PartnerPublicModel {
    export { Benefits, CategoryCommon, CategoryL1, CategoryL2, ContactInfo, Details, ExtensionUsingSlug, ListingInfo, Organization, OrganizationList, Pagination, Plans, Price, Recurring, Screenshots, Support };
}
/** @returns {Benefits} */
...
declare function OrganizationList(): OrganizationList;

...
class FileStorage {
  ...
  async getAllNamespaceDetails(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/assets/v1.0/namespaces`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
   ...
   */
  async getAllOrganizationNamespaceDetails(
    { requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = FileStoragePartnerValidator.getAllOrganizationNamespaceDetails().validate(
      {},
      { abortEarly: false, allowUnknown: true }
    );
    if (error) {
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > FileStorage > getAllOrganizationNamespaceDetails \n ${warrning}`,
      });
    }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > FileStorage > getAllOrganizationNamespaceDetails \n ${res_error}`,
        });
      }
    }
  ...
  async getNamespaceDetail(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/assets/v1.0/namespaces/${namespace}`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
   ...
   */
  async getOrganizationNamespaceDetail(
    { namespace, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = FileStoragePartnerValidator.getOrganizationNamespaceDetail().validate(
      {
        namespace,
      },
      { abortEarly: false, allowUnknown: true }
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > FileStorage > getOrganizationNamespaceDetail \n ${warrning}`,
      });
    }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > FileStorage > getOrganizationNamespaceDetail \n ${res_error}`,
        });
      }
    }
  ...
  async completeUploadFile(
    ...
    const { error } = FileStoragePartnerValidator.completeUploadFile().validate(
      {
        namespace,
        body,
      },
    ...
    const {
      error: warrning,
    } = FileStoragePartnerValidator.completeUploadFile().validate(
      { namespace, body },
      { abortEarly: false, allowUnknown: false }
    );
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > FileStorage > completeUploadFile \n ${warrning}`,
      });
    }
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "post",
      `/service/partner/assets/v1.0/namespaces/${namespace}/upload/complete`,
      query_params,
      body,
      requestHeaders,
      { responseHeaders }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > FileStorage > completeUploadFile \n ${res_error}`,
        });
      }
    }
  ...
  async startUploadFile(
    ...
    const { error } = FileStoragePartnerValidator.startUploadFile().validate(
      {
        namespace,
        body,
      },
    ...
    const {
      error: warrning,
    } = FileStoragePartnerValidator.startUploadFile().validate(
      { namespace, body },
      { abortEarly: false, allowUnknown: false }
    );
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > FileStorage > startUploadFile \n ${warrning}`,
      });
    }
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "post",
      `/service/partner/assets/v1.0/namespaces/${namespace}/upload/start`,
      query_params,
      body,
      requestHeaders,
      { responseHeaders }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > FileStorage > startUploadFile \n ${res_error}`,
        });
      }
    }
  ...
  async browseFiles(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/assets/v1.0/namespaces/${namespace}/browse`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
  ...
  async fetchProxy(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/assets/v1.0/proxy/fetch`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
   ...
   */
  async fetchProxyByOrganization(
    { url, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = FileStoragePartnerValidator.fetchProxyByOrganization().validate(
      {
        url,
      },
      { abortEarly: false, allowUnknown: true }
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > FileStorage > fetchProxyByOrganization \n ${warrning}`,
      });
    }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > FileStorage > fetchProxyByOrganization \n ${res_error}`,
        });
      }
    }
   ...
   */
  async saveProxyByOrganisation(
    { body, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = FileStoragePartnerValidator.saveProxyByOrganisation().validate(
      {
        body,
      },
      { abortEarly: false, allowUnknown: true }
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > FileStorage > saveProxyByOrganisation \n ${warrning}`,
      });
    }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > FileStorage > saveProxyByOrganisation \n ${res_error}`,
        });
      }
    }

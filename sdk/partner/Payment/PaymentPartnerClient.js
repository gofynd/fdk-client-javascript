...
class Payment {
  ...
  async getPaymentconfig(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/payment/v1.0/partner/${this.config.organizationId}/payment/methods/configs`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
  ...
  async getPayout(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/payment/v1.0/partner/${this.config.organizationId}/payouts`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }
  ...
  async getPayouts(
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "get",
      `/service/partner/payment/v1.0/partner/${this.config.organizationId}/payouts/${uniqueTransferNo}`,
      query_params,
      undefined,
      requestHeaders,
      { responseHeaders }

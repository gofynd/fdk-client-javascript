...
class Webhook {
  ...
  async createKafkaConfiguration(
    ...
    const {
      error,
    } = WebhookPartnerValidator.createKafkaConfiguration().validate(
      {
        extensionId,
        body,
      },
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > Webhook > createKafkaConfiguration \n ${warrning}`,
      });
    }
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "post",
      `/service/partner/webhook/v1.0/organization/${this.config.organizationId}/extension/${extensionId}/kafka_config`,
      query_params,
      body,
      requestHeaders,
      { responseHeaders }
    ...
    const {
      error: res_error,
    } = WebhookPartnerModel.KafkaConfigResponse().validate(responseData, {
      abortEarly: false,
      allowUnknown: true,
    });
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > Webhook > createKafkaConfiguration \n ${res_error}`,
        });
      }
    }
   ...
   */
  async fetchKafkaConfiguration(
    { extensionId, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = WebhookPartnerValidator.fetchKafkaConfiguration().validate(
      {
        extensionId,
      },
      { abortEarly: false, allowUnknown: true }
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > Webhook > fetchKafkaConfiguration \n ${warrning}`,
      });
    }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > Webhook > fetchKafkaConfiguration \n ${res_error}`,
        });
      }
    }
  ...
  async updateKafkaConfiguration(
    ...
    const {
      error,
    } = WebhookPartnerValidator.updateKafkaConfiguration().validate(
      {
        extensionId,
        body,
      },
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > Webhook > updateKafkaConfiguration \n ${warrning}`,
      });
    }
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > Webhook > updateKafkaConfiguration \n ${res_error}`,
        });
      }
    }
   ...
   */
  async validateKafkaConfiguration(
    { extensionId, body, requestHeaders } = { requestHeaders: {} },
    { responseHeaders } = { responseHeaders: false }
  ) {
    const {
      error,
    } = WebhookPartnerValidator.validateKafkaConfiguration().validate(
      {
        extensionId,
        body,
      },
    ...
    if (warrning) {
      Logger({
        level: "WARN",
        message: `Parameter Validation warrnings for partner > Webhook > validateKafkaConfiguration \n ${warrning}`,
      });
    }
    ...
    const response = await PartnerAPIClient.execute(
      this.config,
      "post",
      `/service/partner/webhook/v1.0/organization/${this.config.organizationId}/extension/${extensionId}/kafka_config/validate`,
      query_params,
      body,
      requestHeaders,
      { responseHeaders }
    ...
    const {
      error: res_error,
    } = WebhookPartnerModel.KafkaConfigValidateResponse().validate(
      responseData,
      { abortEarly: false, allowUnknown: true }
    );
    ...
    if (res_error) {
      if (this.config.options.strictResponseCheck === true) {
        ...
        Logger({
          level: "WARN",
          message: `Response Validation Warnings for partner > Webhook > validateKafkaConfiguration \n ${res_error}`,
        });
      }
    }

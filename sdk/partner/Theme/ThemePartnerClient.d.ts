...
declare class Theme {
     ...
     */
    getExtensionbinding({ extensionId, bundleName, type, requestHeaders }?: ThemePartnerValidator.GetExtensionbindingParam, { responseHeaders }?: object): Promise<ThemePartnerModel.DraftExtensionSection>;
    /**
     ...
     */
    publishExtensionSections({ extensionId, body, requestHeaders }?: ThemePartnerValidator.PublishExtensionSectionsParam, { responseHeaders }?: object): Promise<ThemePartnerModel.PublishExtensionSectionResponseSchema>;
    /**

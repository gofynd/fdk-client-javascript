...
```javascript
// Promise
const promise = catalog.getProducts(companyId,brandIds,categoryIds,q,pageNo,pageSize);

// Async/Await
const data = await catalog.getProducts(companyId,brandIds,categoryIds,q,pageNo,pageSize);
```

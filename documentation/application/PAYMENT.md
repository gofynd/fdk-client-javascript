...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- |
| body | [cardDetails](#cardDetails) | yes | Request body |
...
---
 ...
 | aggregator | string |  yes  | Aggregator name like juspay |
...
---
 ...
 | is_domestic_card | string |  yes  | Is card domestic or international |

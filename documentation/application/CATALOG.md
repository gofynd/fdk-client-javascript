...
#### [ProductDetails](#ProductDetails)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || attributes | string |  no  |  || brand_uid | number |  no  |  || country_of_origin | string |  no  |  || description | string |  no  |  || grouped_attributes | string |  no  |  || has_variant | boolean |  no  |  || highlights | [string] |  no  |  || hsn_code | number |  no  |  || identifier | string |  no  |  || image_nature | string |  no  |  || images | [string] |  no  |  || is_set | boolean |  no  |  || item_code | string |  no  |  || media | [string] |  no  |  || name | string |  no  |  || out_of_stock | boolean |  no  |  || rating | number |  no  |  || rating_count | number |  no  |  || short_description | string |  no  |  || slug | string |  no  |  || template_tag | string |  no  |  |
...
#### [ProductGroupingModel](#ProductGroupingModel)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || _id | any |  no  |  || choice | string |  no  |  || company_id | number |  no  |  || created_by | [UserDetail](#UserDetail) |  no  |  || created_on | string |  yes  |  || is_active | boolean |  no  |  || logo | string |  no  |  || meta | string |  no  |  || modified_by | [UserDetail](#UserDetail) |  no  |  || modified_on | string |  yes  |  || name | string |  yes  |  || page_visibility | [string] |  no  |  || products | [[ProductInGroup](#ProductInGroup)] |  yes  |  || same_store_assignment | boolean |  no  |  || slug | string |  no  |  || verified_by | [UserDetail](#UserDetail) |  no  |  || verified_on | string |  no  |  |

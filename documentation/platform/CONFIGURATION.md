...
#### [AppCartConfig](#AppCartConfig)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || bulk_coupons | boolean |  no  |  || delivery_charges | [DeliveryCharges](#DeliveryCharges) |  no  |  || empty_cart | boolean |  no  |  || enabled | boolean |  no  |  || max_cart_items | number |  no  |  || min_cart_value | number |  no  |  || revenue_engine_coupon | boolean |  no  |  |

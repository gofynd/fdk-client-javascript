...
* [getAppZoneProducts](#getappzoneproducts)
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").catalog.updateAppLocation({  brandUid : value,
 storeUid : value,
 body : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").catalog.updateAppLocation({  brandUid : value,
 storeUid : value,
 body : value });
```
...
### getAppZoneProducts
Get zonewise application products



```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").catalog.getAppZoneProducts({  brandIds : value,
 categoryIds : value,
 departmentIds : value,
 tags : value,
 pageNo : value,
...
// Async/Await
const data = await client.application("<APPLICATION_ID>").catalog.getAppZoneProducts({  brandIds : value,
 categoryIds : value,
 departmentIds : value,
 tags : value,
 pageNo : value,

...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").companyProfile.updateAppBrand({  brandUid : value,
 body : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").companyProfile.updateAppBrand({  brandUid : value,
 body : value });
```

...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").payment.getUserCODlimitRoutes();

// Async/Await
const data = await client.application("<APPLICATION_ID>").payment.getUserCODlimitRoutes();
```

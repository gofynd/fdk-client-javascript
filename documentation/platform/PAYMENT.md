...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").payment.edcAggregatorsList();

// Async/Await
const data = await client.application("<APPLICATION_ID>").payment.edcAggregatorsList();
```

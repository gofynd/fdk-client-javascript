...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.deleteCart({  id : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.deleteCart({  id : value });
```
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.getPlatformPOSCoupons({  id : value,
 buyNow : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.getPlatformPOSCoupons({  id : value,
 buyNow : value });
```

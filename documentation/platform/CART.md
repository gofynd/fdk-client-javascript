...
#### [OverrideCartItem](#OverrideCartItem)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || amount_paid | number |  yes  |  || discount | number |  yes  |  || extra_meta | string |  no  |  || item_id | number |  yes  |  || price_effective | number |  yes  |  || price_marked | number |  yes  |  || promo_list | [[OverrideCartItemPromo](#OverrideCartItemPromo)] |  no  |  || quantity | number |  no  |  || seller_identifier | string |  no  |  || size | string |  yes  |  |
...
#### [OverrideCartItemPromo](#OverrideCartItemPromo)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || item_list | [string] |  no  |  || promo_amount | string |  yes  |  || promo_desc | string |  no  |  || promo_id | string |  yes  |  || rwrd_tndr | string |  no  |  |
...
#### [OverrideCheckoutReq](#OverrideCheckoutReq)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || aggregator | string |  yes  |  || billing_address | string |  no  |  || cart_id | string |  yes  |  || cart_items | [[OverrideCartItem](#OverrideCartItem)] |  yes  |  || currency_code | string |  yes  |  || merchant_code | string |  yes  |  || order_type | string |  yes  |  || ordering_store | number |  no  |  || payment_identifier | string |  yes  |  || payment_mode | string |  yes  |  || shipping_address | string |  no  |  |
...
#### [OverrideCheckoutResponse](#OverrideCheckoutResponse)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- || cart | string |  yes  |  || data | string |  yes  |  || message | string |  yes  |  || order_id | string |  yes  |  || success | string |  yes  |  |

...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.getCartList();

// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.getCartList();
```
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.updateCartUser({  id : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.updateCartUser({  id : value });
```
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.addItems({  body : value,
 i : value,
 b : value,
 buyNow : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.addItems({  body : value,
 i : value,
 b : value,
 buyNow : value });
```
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.updateCart({  body : value,
 id : value,
 i : value,
 b : value,
 buyNow : value });
...
// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.updateCart({  body : value,
 id : value,
 i : value,
 b : value,
 buyNow : value });
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.getCoupons({  id : value,
 buyNow : value });

// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.getCoupons({  id : value,
 buyNow : value });
```
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.getShipments({  p : value,
 id : value,
 buyNow : value,
 addressId : value,
 areaCode : value });
...
// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.getShipments({  p : value,
 id : value,
 buyNow : value,
 addressId : value,
 areaCode : value });
...
```javascript
// Promise
const promise = client.application("<APPLICATION_ID>").cart.getShipmentDelivery({  i : value,
 p : value,
 id : value,
 addressId : value,
 orderType : value });
...
// Async/Await
const data = await client.application("<APPLICATION_ID>").cart.getShipmentDelivery({  i : value,
 p : value,
 id : value,
 addressId : value,
 orderType : value });
...
---
 ...
 | area_code | string |  no  |  |
 | city | string |  no  |  |
 | geo_location | [GeoLocation1](#GeoLocation1) |  no  |  |
 | address | string |  no  |  |
 | user_id | string |  no  |  |
 | meta | string |  no  |  |
 | state | string |  no  |  |

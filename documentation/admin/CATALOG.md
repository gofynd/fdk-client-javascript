...
#### [AttributeMaster](#AttributeMaster)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | allowed_values | [string]? |  yes  | The list of allowed values for the attribute |
...
#### [AttributeMasterDetails](#AttributeMasterDetails)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | display_type | string |  no  | The display type of the attribute |
...
#### [AttributeMasterFilter](#AttributeMasterFilter)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | depends_on | [string]? |  yes  | The list of attributes on which this attribute depends |
 | indexing | boolean |  no  | Whether to index the attribute or not |
 | priority | number? |  yes  | The priority of the attribute for filtering |
...
#### [AttributeMasterGroupComparisons](#AttributeMasterGroupComparisons)
 ...
 | priority | number? |  yes  | Priority of the comparison attribute group for sorting |
 | template_slugs | [string]? |  yes  | List of template slugs related to the comparison attribute group |
...
#### [AttributeMasterGroupDetails](#AttributeMasterGroupDetails)
 ...
 | priority | number? |  yes  | Priority of the attribute group for sorting |
 | template_slugs | [string]? |  yes  | List of template slugs related to the attribute group |
...
#### [AttributeMasterGroupModel](#AttributeMasterGroupModel)
 ...
 | uid | number |  no  | Unique ID of the attribute group |
...
#### [AttributeMasterModel](#AttributeMasterModel)
 ...
 | enabled_for_end_consumer | boolean? |  yes  | Whether the attribute is enabled for end consumers or not |
 | filters | [AttributeMasterFilter](#AttributeMasterFilter) |  no  | Filters of the attribute |
 | is_nested | boolean? |  yes  | Whether the attribute is nested or not |
 | logo | string? |  yes  | The URL of the attribute logo |
 | modified_by | [UserDetail](#UserDetail)? |  yes  | User details of the last modifier of the document |
 | modified_on | string |  no  | Timestamp of the last modification of the document |
 | name | string? |  yes  | The name of the attribute |
 | raw_key | string? |  yes  | The raw key of the attribute |
 ...
 | synonyms | string? |  yes  | Dictionary of synonyms for the attribute |
...
#### [AttributeSchemaRange](#AttributeSchemaRange)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | max | number? |  yes  | The maximum value of the attribute range |
 | min | number? |  yes  | The minimum value of the attribute range |
...
#### [BulkExportJobModel](#BulkExportJobModel)
 ...
 | created_by | [UserDetail](#UserDetail)? |  yes  | User details of the creator of the document |
 | created_on | string |  no  | Timestamp of the creation of the document |
 | file_type | string |  no  | It contains the type of file. |
 ...
 | job_type | string |  no  | It contains the name of entity for the job. |
 | modified_by | [UserDetail](#UserDetail)? |  yes  | User details of the last modifier of the document |
 | modified_on | string |  no  | Timestamp of the last modification of the document |
...
#### [ProductTemplateModel](#ProductTemplateModel)
 ...
 | is_active | boolean? |  yes  | Flag to indicate if the product template is active or not |
 | is_archived | boolean? |  yes  | Flag to indicate if the product template is archived or not |
 | is_expirable | boolean? |  yes  | Flag to indicate if the product template is expirable or not |
 | is_physical | boolean |  no  | Flag to indicate if the product template is physical or not |
...
#### [ProductVerificationModel](#ProductVerificationModel)
 ...
 | ---------- | ---- | -------- | ----------- |
 | _id | any? |  yes  |  |
 | brand_uid | number |  no  | The unique identifier of the brand |
 | company_ids | [number] |  no  | The list of company IDs associated with the product |
 | created_by | [UserDetail](#UserDetail)? |  yes  | User details of the creator of the document |
 | created_on | string |  no  | Timestamp of the creation of the document |
 | item_code | string |  no  | The item code of the product being verified |
 | item_id | number |  no  | The unique identifier of the item being verified |
 | modified_by | [UserDetail](#UserDetail)? |  yes  | User details of the last modifier of the document |
 | modified_on | string |  no  | Timestamp of the last modification of the document |
 | product | string? |  yes  | The product information being verified |
 | rejected_fields | string? |  yes  | A dictionary of any rejected fields and their corresponding values |
...
#### [SwatchImageConfig](#SwatchImageConfig)
 ...
 | max_height | number? |  yes  | Maximum height of the image |
 | max_size | number? |  yes  | Maximum size of the image in bytes |
...
#### [VariantAttributesModel](#VariantAttributesModel)
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | _cls | string? |  yes  | Class name of the variant attribute |
 | _id | any? |  yes  |  |
 | created_by | [UserDetail](#UserDetail)? |  yes  | User details of the creator of the document |
 | created_on | string |  no  | Timestamp of the creation of the document |
 ...
 | modified_by | [UserDetail](#UserDetail)? |  yes  | User details of the last modifier of the document |
 | modified_on | string |  no  | Timestamp of the last modification of the document |
 | priority | number? |  yes  | Priority of the variant attribute |
 | templates | [string]? |  yes  | List of templates for the variant attribute |
 | uid | number? |  yes  | Unique ID of the variant attribute |
 | verified_by | [UserDetail](#UserDetail)? |  yes  | User details of the verifier of the document, if applicable |
 | verified_on | string? |  yes  | Timestamp of when the document was verified, if applicable |
